// coverage: addr=0x0016dad8 symbol=func_0016dad8 size=72 class=branchy source=twins status=exact fuzzy=100.0
...
void func_0016dad8_impl(u32 a0) asm("_ZN2YS20trap_vector_to_angleEP8BD_VALUE");
void func_0016dad8_impl(u32 a0) {
    u32 s0 = a0;
    kn::FVector tmp;
    func_0017d050((u32)&tmp, *(u32*)((u32)a0 + (s32)(0)));
    u32 t7 = (u32)&D_004f62a0;
