// coverage: addr=0x00273078 symbol=func_00273078 size=200 class=branchy source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:near:79.49;ghidra:near:70.93
...
extern "C" u32 D_00373af8 asm("D_00373af8");
extern "C" u32 func_00192048(u32) asm("func_00192048");
extern "C" u32 func_001a9ae8(u32, u32, u32, u32) asm("func_001a9ae8");
extern "C" u32 func_0023a918(u32) asm("func_0023a918");
extern "C" u32 func_0023aa98(u32) asm("func_0023aa98");
extern "C" u32 func_00287bc0(u32, u32, u32) asm("func_00287bc0");
extern "C" u32 func_0028b160(u32, u32) asm("func_0028b160");
extern "C" void func_001a98e8(u32, u32, u32, u32, u32) asm("func_001a98e8");

// 0x00273078 func_00273078
u32 func_00273078(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4) asm("func_00273078");
u32 func_00273078(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4) {
    u8 frame[96];
    u32 v0;
    u32 v0_0;
    u32 s0;
    u32 s0_1;
    u32 v0_2;
    v0 = func_00287bc0(a0, a1, a2);
    if ((v0 == 0x1f)) {
        v0_0 = func_0028b160(*(u32*)(&D_0035f01c), a4);
        s0 = *(u32*)&(((dk_SpriteMessage*)a4)->m_fontSize);
        func_001a98e8((u32)frame, 1, func_00192048(*(u16*)(((((s32)((v0_0 + (v0_0 >> 0x1f))) >> 1) << 3) + (u32)&D_00373af8))), s0, 0);
        s0_1 = (a0 + func_0023aa98(a4 + 0x18));
        v0_2 = func_001a9ae8((u32)frame, s0_1, a1, func_0023a918(a4 + 0x18));
        v0 = v0_2;
    }
    return v0;
}
