// coverage: addr=0x00234098 symbol=_Z16wtarget_00234098jjjj size=84 class=straight source=lift status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:60.96;ghidra:near:31.84
...
// 0x00234098 wtarget_00234098(unsigned int, unsigned int, unsigned int, unsigned int)
u32 lift_00234098(u32 a0, u32 a1, u32 a2) asm("_Z16wtarget_00234098jjjj");
u32 lift_00234098(u32 a0, u32 a1, u32 a2) {
    u32 t6;
    u32 t3;
    t6 = *(u32*)(&D_0035e360);
    t3 = *(u32*)(&D_0035e368);
    *(u32*)(((t6 << 5) + (u32)&D_01dadc00)) = 1;
