// coverage: addr=0x001fa928 symbol=func_001fa928 size=36 class=straight source=corpus status=exact fuzzy=100.0
...
void func_001fa928_impl(pppPObject* pobj, pppCtrlTable* ctbl) asm("func_001fa928");
void func_001fa928_impl(pppPObject* pobj, pppCtrlTable* ctbl) {
