// coverage: addr=0x001d18c0 symbol=func_001d18c0 size=76 class=branchy source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:near:89.16;ghidra:near:78.96
...
extern "C" u32 func_001d1950(u32, u32) asm("func_001d1950");
extern "C" void func_0014f688(u32, u32, u32, u32, u32) asm("func_0014f688");
extern "C" void func_001d16f8(u32) asm("func_001d16f8");

// 0x001d18c0 func_001d18c0
u32 func_001d18c0(u32 a0) asm("func_001d18c0");
u32 func_001d18c0(u32 a0) {
    func_001d16f8(a0);
    if (((s32)(*(u32*)&(((YS_MISSION_WATCH*)a0)->super_MISSION2D.super_IMAGE_DATA.Imd)) != 0)) {
        func_0014f688(*(u32*)&(((YS_MISSION_WATCH*)a0)->super_MISSION2D.super_IMAGE_DATA.Imd), *(u32*)&(((YS_MISSION_WATCH*)a0)->super_MISSION2D.super_IMAGE_DATA.Sqd), *(u32*)&(((YS_MISSION_WATCH*)a0)->super_MISSION2D.Align), *(u32*)&(((YS_MISSION_WATCH*)a0)->super_MISSION2D.Priority), *(u32*)&(((YS_MISSION_WATCH*)a0)->super_MISSION2D.Warning));
    }
    return func_001d1950(a0, *(u32*)&(((YS_MISSION_WATCH*)a0)->super_MISSION2D.Start));
}
