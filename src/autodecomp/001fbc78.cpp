// coverage: addr=0x001fbc78 symbol=func_001fbc78 size=36 class=straight source=corpus status=exact fuzzy=100.0
...
void func_001fbc78_impl(pppPObject* pobj, pppCtrlTable* ctbl) asm("func_001fbc78");
void func_001fbc78_impl(pppPObject* pobj, pppCtrlTable* ctbl) {
