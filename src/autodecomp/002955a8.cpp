// coverage: addr=0x002955a8 symbol=func_002955a8 size=192 class=loop source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:83.7;m2c:near:78.88
...
s32 FUN_00138c10(...) asm("func_00138c10");
s32 FUN_002891b8(...) asm("func_002891b8");
s32 FUN_0028afa8(...) asm("func_0028afa8");
s32 FUN_0028b040(...) asm("func_0028b040");
s32 FUN_002955a8(...) asm("func_002955a8");
extern u32 DAT_0035f200 asm("D_0035f200");

// Ghidra decompile of 0x002955a8, wrapped mechanically (ad/fallback.py)

void FUN_002955a8_impl(void) asm("func_002955a8");
void FUN_002955a8_impl(void) {
  int iVar1;
  int iVar2;
  undefined8 uVar3;
  int iVar4;
  ...
  iVar5 = 0;
  iVar1 = FUN_0028afa8(DAT_0035f200);
  iVar2 = FUN_0028b040(DAT_0035f200);
  if (0 < iVar1) {
    do {
      iVar4 = FUN_002891b8(DAT_0035f200,iVar5);
      if (*(int *)(iVar4 + 0x184) == 0xac) {
        uVar3 = FUN_002891b8(DAT_0035f200,iVar5);
        FUN_00138c10(uVar3,0xad);
      }
      if (iVar5 == iVar2) {
        uVar3 = FUN_002891b8(DAT_0035f200,iVar5);
        FUN_00138c10(uVar3,0xac);
      }
      iVar5 = iVar5 + 1;
    } while (iVar5 < iVar1);
  }
