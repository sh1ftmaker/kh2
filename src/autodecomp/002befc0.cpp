// coverage: addr=0x002befc0 symbol=func_002befc0 size=212 class=straight source=typed status=exact fuzzy=100.0
...
// 0x002befc0 func_002befc0
u32 func_002befc0(u32 a0) asm("func_002befc0");
u32 func_002befc0(u32 a0) {
    u32 s1;
    u32 v0;
    u32 s1_0;
    s1 = func_001050c8(a0);
