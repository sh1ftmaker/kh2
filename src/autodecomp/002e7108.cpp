// coverage: addr=0x002e7108 symbol=func_002e7108 size=136 class=float source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:81.49;ghidra:near:54.11
...
// m2c raw+unkfix output for 0x002e7108, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_002E7108 {
    /* 0x00 */ char pad0[0x30];
};                                                  /* size = 0x30 */

s32 func_002E64B8(s32 = 0, s32 = 0) asm("func_002E64B8");
s32 func_002E6AB0(s32 = 0, s32 = 0, f32 = 0) asm("func_002E6AB0");
void func_002E7108(void *arg0 = 0, f32 fparg0 = 0, ...) asm("func_002e7108");
void func_002e7108_impl(void *arg0, f32 fparg0) asm("func_002e7108");
void func_002e7108_impl(void *arg0, f32 fparg0) {
    s32 temp_a0;
    s32 temp_s0;
    s32 temp_s3;
    s32 var_s1;
    ...
    var_s1 = 0;
    temp_s3 = (*(s32*)((s8*)arg0 + 0x8));
    if (temp_s3 > 0) {
        do {
            temp_a0 = var_s1;
            temp_s0 = (*(s32*)((s8*)arg0 + 0x4)) + (var_s1 << 6);
            var_s1 += 1;
            func_002E6AB0(func_002E64B8(temp_a0, (*(s32*)((s8*)arg0 + 0x0))), temp_s0, fparg0);
