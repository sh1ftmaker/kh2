// coverage: addr=0x002343a8 symbol=_Z16wtarget_002343a8jjjj size=88 class=straight source=lift status=exact fuzzy=100.0
...
// 0x002343a8 wtarget_002343a8(unsigned int, unsigned int, unsigned int, unsigned int)
u32 lift_002343a8(u32 a0, u32 a1, u32 a2, u32 a3) asm("_Z16wtarget_002343a8jjjj");
u32 lift_002343a8(u32 a0, u32 a1, u32 a2, u32 a3) {
    u32 t6;
    u32 t3;
    t6 = *(u32*)(&D_0035e360);
    t3 = *(u32*)(&D_0035e368);
