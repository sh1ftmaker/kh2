// coverage: addr=0x00234400 symbol=func_00234400 size=96 class=straight source=lift status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:61.2;ghidra:near:29.02
...
struct S32_24_u32 { u8 _p[24]; u32 m; u8 _q[4]; };
struct S32_28_u32 { u8 _p[28]; u32 m; };
...
// 0x00234400 func_00234400
u32 func_00234400(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4, u32 a5) asm("func_00234400");
u32 func_00234400(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4, u32 a5) {
    u32 t6;
    u32 t3;
    t6 = *(u32*)(&D_0035e360);
    t3 = *(u32*)(&D_0035e368);
    *(u32*)(((t6 << 5) + (u32)&D_01dadc00)) = 0xa;
    ...
    ((S32_24_u32*)&D_01dadc00)[t6].m = a4;
    ((S32_28_u32*)&D_01dadc00)[t6].m = a5;
