// coverage: addr=0x002409b8 symbol=func_002409b8 size=76 class=branchy source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:96.84;m2c:near:94.9
...
s32 FUN_002409b8(...) asm("func_002409b8");
s32 FUN_00242408(...) asm("func_00242408");
s32 FUN_00242418(...) asm("func_00242418");
extern u32 DAT_0035ec90 asm("D_0035ec90");

// Ghidra decompile of 0x002409b8, wrapped mechanically (ad/fallback.py)

void FUN_002409b8_impl(int param_1) asm("func_002409b8");
void FUN_002409b8_impl(int param_1) {
  if (param_1 == 0) {
    param_1 = DAT_0035ec90;
  }
  FUN_00242408();
  FUN_00242418(param_1,8);
  FUN_00242418(param_1 + 0xc,0x10fb4);
  return;
}
