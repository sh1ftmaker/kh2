// coverage: addr=0x001ad158 symbol=func_001ad158 size=116 class=straight source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:near:98.48;ghidra:near:84.42
...
struct YS_WINDOW_BALLOON {  // class YS::WINDOW_BALLOON size=0xb6c
...
extern "C" u32 func_001050d8(u32, u32, u32, u32) asm("func_001050d8");
extern "C" u32 func_001ad0f8(u32, u32, u32) asm("func_001ad0f8");

// 0x001ad158 func_001ad158
u32 func_001ad158(u32 a0, u32 a1, u32 a2, u32 a3) asm("func_001ad158");
u32 func_001ad158(u32 a0, u32 a1, u32 a2, u32 a3) {
    u32 v0;
    u32 v0_0;
    v0 = func_001050d8(0xb6c, a1, a2, a3);
    v0_0 = func_001ad0f8(v0, a3, 0);
    *(u32*)&(((YS_WINDOW_BALLOON*)a0)->super_WINDOW_BASE.Child) = v0;
    *(u32*)((v0 + 4)) = a1;
    *(u32*)((v0 + 8)) = a2;
    return v0_0;
}
