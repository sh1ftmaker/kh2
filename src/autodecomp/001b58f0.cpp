// coverage: addr=0x001b58f0 symbol=func_001b58f0 size=36 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:48.89;lift:near:26.67
...
s32 FUN_001b58f0(...) asm("func_001b58f0");
s32 FUN_001de168(...) asm("func_001de168");

// Ghidra decompile of 0x001b58f0, wrapped mechanically (ad/fallback.py)

void FUN_001b58f0_impl(int param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4) asm("func_001b58f0");
void FUN_001b58f0_impl(int param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4) {
  FUN_001de168(param_1 + 0x18,param_2,param_3,1,30000,param_4);
  return;
}
