// coverage: addr=0x001de328 symbol=func_001de328 size=176 class=loop source=m2c status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:71.77;lift:near:4.88
...
// m2c valid-syntax output for 0x001de328, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_001DE328 {
    /* 0x00 */ char pad0[0x10];
};                                                  /* size = 0x10 */

M2C_UNK func_001E0058(void *) asm("func_001E0058");
M2C_UNK func_001DC920(s32 = 0) asm("func_001DC920");
void func_001DE328(void *arg0 = 0, s32 arg1 = 0, ...) asm("func_001de328");
void func_001de328_impl(void *arg0, s32 arg1) asm("func_001de328");
void func_001de328_impl(void *arg0, s32 arg1) {
    void *temp_t3;
    void *temp_t5;
    void *temp_t7;
    void *var_s0;
    ...
    if (var_s0 != NULL) {
loop_1:
        temp_t5 = M2C_FIELD(var_s0, void **, 0x60);
        if (M2C_FIELD(M2C_FIELD(var_s0, void **, 0x44), u16 *, 2) == arg1) {
            temp_t3 = arg0 + 0xC;
            if (var_s0 == var_t4) {
                M2C_FIELD(arg0, void **, 0xC) = temp_t5;
                var_t4 = NULL;
            } else {
                var_t6 = M2C_FIELD(var_t4, void **, 0x60);
                if (var_t6 == var_s0) {
                    M2C_FIELD(var_t4, void **, 0x60) = temp_t5;
                } else {
                    do {
                        temp_t7 = M2C_FIELD(var_t6, void **, 0x60);
                        var_t4 = var_t6;
                        var_t6 = temp_t7;
                    } while (temp_t7 != var_s0);
                    M2C_FIELD(var_t4, void **, 0x60) = temp_t5;
                }
            }
            if (var_s0 == M2C_FIELD(temp_t3, void **, 4)) {
                M2C_FIELD(temp_t3, void **, 4) = var_t4;
            }
            M2C_FIELD(var_s0, void **, 0x60) = NULL;
            func_001DC920(M2C_FIELD(var_s0, s32 *, 0x40));
            func_001E0058(var_s0);
            return;
        }
        var_s0 = temp_t5;
        if (temp_t5 == NULL) {
