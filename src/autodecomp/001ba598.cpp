// coverage: addr=0x001ba598 symbol=func_001ba598 size=184 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:87.35;lift:near:79.85;e3:near:75.61
...
// m2c valid-syntax output for 0x001ba598, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_001BA598 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

s32 func_00176B58(s32 = 0) asm("func_00176B58");
void *func_00177860(s32 = 0) asm("_ZN2YS5PARTY11get_abilityEv");
s32 func_0019BA60(s32 = 0) asm("func_0019BA60");
s32 func_001A2A50(s32 = 0, s32 = 0, s32 = 0, s32 = 0) asm("func_001A2A50");
M2C_UNK func_001D02C8(s32 = 0) asm("func_001D02C8");
M2C_UNK func_001D97C8() asm("func_001D97C8");
void func_001BA598(void *arg0 = 0, ...) asm("_ZN2YS11ITEM_EFFECT3useEv");
void func_001ba598_impl(void *arg0) asm("_ZN2YS11ITEM_EFFECT3useEv");
void func_001ba598_impl(void *arg0) {
    s32 temp_t6;
    s32 temp_v0;
    s32 var_s2;

    if (M2C_FIELD(arg0, s32 *, 4) != 0) {
        temp_t6 = M2C_FIELD(arg0, s32 *, 0xC);
        if (temp_t6 == 4) {
            func_001D02C8(M2C_FIELD(arg0, s32 *, 8));
        } else {
            var_s2 = 0x64;
            temp_v0 = func_00176B58(temp_t6);
            if (func_0019BA60(temp_v0) != 0) {
                var_s2 = M2C_FIELD(func_00177860(temp_v0), u16 *, 0x50) + 0x64;
            }
            if ((func_001A2A50(M2C_FIELD(arg0, s32 *, 4), M2C_FIELD(arg0, s32 *, 0x10), M2C_FIELD(arg0, s32 *, 0xC), var_s2) != 0) && (M2C_FIELD(arg0, s32 *, 0xC) == 1)) {
                func_001D97C8();
            }
        }
