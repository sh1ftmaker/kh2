// coverage: addr=0x00234460 symbol=func_00234460 size=96 class=straight source=lift status=exact fuzzy=100.0
...
// 0x00234460 func_00234460
u32 func_00234460(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4, u32 a5) asm("func_00234460");
u32 func_00234460(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4, u32 a5) {
    u32 t6;
    u32 t3;
    t6 = *(u32*)(&D_0035e360);
    t3 = *(u32*)(&D_0035e368);
    *(u32*)(((t6 << 5) + (u32)&D_01dadc00)) = 0xb;
