// coverage: addr=0x00179c80 symbol=func_00179c80 size=52 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:59.21;ghidra:near:33.0
...
// m2c raw+unkfix output for 0x00179c80, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_00179C80 {};                 /* size 0x0 */

s32 func_00179C80(void *arg0 = 0, ...) asm("func_00179c80");
s32 func_00179c80_impl(void *arg0) asm("func_00179c80");
s32 func_00179c80_impl(void *arg0) {
    s32 temp_a0;
    s32 var_v0;

    var_v0 = 0;
    if (((*(s32*)((s8*)arg0 + 0xB50)) == 7) && ((temp_a0 = (*(s32*)((s8*)arg0 + 0x154)), (temp_a0 == 0xCB)) || (temp_a0 == 0xCC))) {
        var_v0 = 1;
    }
    return var_v0;
}
