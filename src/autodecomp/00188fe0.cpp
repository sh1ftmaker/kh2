// coverage: addr=0x00188fe0 symbol=_ZN2YS14SAVERAM_BATTLE11get_partramEi size=68 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:92.65;ghidra:near:53.75;e3:near:47.61
...
// m2c raw output for 0x00188fe0, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_00188FE0 {
    /* 0x00 */ char pad0[0x10];
};                                                  /* size = 0x10 */

s32 func_001B7818(s32 = 0) asm("func_001B7818");
s32 func_00188FE0(s32 arg0 = 0, s32 arg1 = 0, ...) asm("_ZN2YS14SAVERAM_BATTLE11get_partramEi");
s32 func_00188fe0_impl(s32 arg0, s32 arg1) asm("_ZN2YS14SAVERAM_BATTLE11get_partramEi");
s32 func_00188fe0_impl(s32 arg0, s32 arg1) {
    s32 temp_v0;
    s32 var_v0;

    temp_v0 = func_001B7818(arg1);
    if (temp_v0 != 0) {
        var_v0 = (arg0 + (temp_v0 * 0x114)) - 0x114;
    } else {
        var_v0 = 0;
    }
    return var_v0;
