// coverage: addr=0x0016c7a0 symbol=func_0016c7a0 size=52 class=straight source=twins status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:84.62;e3:near:33.47;m2c:compile:0.0
...
void func_001d8d08(f32, u32) asm("func_001d8d08");
...
u32 func_0016c7a0_impl(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4, u32 a5, u32 a6, u32 a7) asm("func_0016c7a0");
u32 func_0016c7a0_impl(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4, u32 a5, u32 a6, u32 a7) {
    u32 r5 = a0;
    u32 r6 = (u32)__builtin_return_address(0);
    u32 r4 = *(volatile u32*)((u32)&D_004f6288 + (s32)(0));
