// coverage: addr=0x0011cd80 symbol=func_0011cd80 size=108 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:98.89;m2c:near:71.15
...
s32 FUN_0011c798(...) asm("func_0011c798");
s32 FUN_0011ca20(...) asm("func_0011ca20");
s32 FUN_0011cd80(...) asm("func_0011cd80");

// Ghidra decompile of 0x0011cd80, wrapped mechanically (ad/fallback.py)

void FUN_0011cd80_impl(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4, undefined8 param_5,undefined8 param_6) asm("func_0011cd80");
void FUN_0011cd80_impl(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4, undefined8 param_5,undefined8 param_6) {
  FUN_0011c798(param_1,param_5);
  FUN_0011ca20(param_1,param_2,param_3,param_4,param_6);
  return;
}
