// coverage: addr=0x00123e00 symbol=_ZNK2kn10ModelMulti6getHrcEv size=48 class=straight source=ghidra status=exact fuzzy=100.0
...
s32 FUN_00123e00(...) asm("_ZNK2kn10ModelMulti6getHrcEv");
s32 FUN_00124748(...) asm("func_00124748");

// Ghidra decompile of 0x00123e00, wrapped mechanically (ad/fallback.py)

void FUN_00123e00_impl(undefined8 param_1) asm("_ZNK2kn10ModelMulti6getHrcEv");
void FUN_00123e00_impl(undefined8 param_1) {
  undefined8 uVar1;
  
  uVar1 = FUN_00124748(param_1,0);
  (**(code **)(*(int *)uVar1 + 0x20))(uVar1);
  return;
}
