// coverage: addr=0x001fae80 symbol=func_001fae80 size=36 class=straight source=corpus status=exact fuzzy=100.0
...
void func_001fae80_impl(pppPObject* pobj, pppCtrlTable* ctbl) asm("func_001fae80");
void func_001fae80_impl(pppPObject* pobj, pppCtrlTable* ctbl) {
