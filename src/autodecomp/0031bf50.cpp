// coverage: addr=0x0031bf50 symbol=func_0031bf50 size=120 class=loop source=typed status=exact fuzzy=100.0
...
// 0x0031bf50 func_0031bf50
u32 func_0031bf50(u32 a0) asm("func_0031bf50");
u32 func_0031bf50(u32 a0) {
    u32 s1;
    u32 s2;
    u32 v0_0;
    *(u32*)&(((Tz_TimeDraw*)a0)->m_Parent) = (u32)&D_0034a618;
    *(u32*)((a0 + 0xc)) = 0;
    *(u32*)((a0 + 0x30)) = (u32)&D_00347e60;
    *(u32*)((a0 + 0x3c)) = 0;
    func_00239700(a0 + 0x48);
    s1 = 6;
    s2 = 0xffffffff;
    do {
        v0_0 = func_00239700((a0 + ((s1 - 6) * -0x158)) + 0x1c8);
        s1 = (s1 + -1);
    } while ((s1 != s2));
    return v0_0;
}
