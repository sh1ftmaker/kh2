// coverage: addr=0x001eb0c8 symbol=func_001eb0c8 size=116 class=float source=corpus status=exact fuzzy=100.0
// coverage-alternatives: lift:near:62.06;ghidra:near:59.17;m2c:near:0.0
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppChrSclXZMatrix.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppChrSclXZMatrix.c"
...
void func_002f4000(sceVu0FMATRIX m);
...
# 2 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppChrSclXZMatrix.c" 2
...
void pppChrSclXZMatrixCalc(pppPObject* pobj, PChrSclXZMatrix* p);



void func_001eb0c8_impl(pppPObject* pobj, PChrSclXZMatrix* p) asm("func_001eb0c8");
void func_001eb0c8_impl(pppPObject* pobj, PChrSclXZMatrix* p) {
    sceVu0FMATRIX m;

    func_002f4000(m);

    m[0][0] = D_01d9e6e0->scaleX + (D_01d9e6e0->scaleX * p->sclr);
    if (m[0][0] > p->maxscl) {
        m[0][0] = p->maxscl;
    }
    ...
    func_002f3d08(D_01d9e6e8.next->cmat, m, D_01d9e6e8.next->cmat);
}
