// coverage: addr=0x002e8578 symbol=func_002e8578 size=72 class=branchy source=twins status=exact fuzzy=100.0
// coverage-alternatives: lift:near:83.56;m2c:near:58.23;ghidra:near:44.62
...
void func_002e8578_impl(u32 a0) asm("_ZN2Ts21trap_bghit_get_normalEP8BD_VALUE");
void func_002e8578_impl(u32 a0) {
    u32 s0 = a0;
    kn::FVector tmp;
    func_001d3698((u32)&tmp, *(u32*)((u32)a0 + (s32)(0)));
    u32 t7 = (u32)&D_01e2bf80;
