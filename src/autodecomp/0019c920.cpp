// coverage: addr=0x0019c920 symbol=func_0019c920 size=80 class=straight source=lift status=exact fuzzy=100.0
...
// 0x0019c920 func_0019c920
u32 func_0019c920(u32 a0) asm("func_0019c920");
u32 func_0019c920(u32 a0) {
    u32 v0;
    *(u32*)(a0) = 0;
    func_00190128(a0 + 4);
    *(u32*)((a0 + 0x18)) = 0;
