// coverage: addr=0x00320198 symbol=func_00320198 size=72 class=straight source=lift status=exact fuzzy=100.0
...
// 0x00320198 func_00320198
u32 func_00320198(u32 a0) asm("func_00320198");
u32 func_00320198(u32 a0) {
