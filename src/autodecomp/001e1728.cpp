// coverage: addr=0x001e1728 symbol=func_001e1728 size=144 class=switch source=m2c status=near fuzzy=99.94
// coverage-alternatives: lift:near:94.44;ghidra:near:27.41
...
// m2c raw+unkfix output for 0x001e1728, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_001E1728 {
    /* 0x00 */ char pad0[0x10];
};                                                  /* size = 0x10 */

s32 func_001E0FE0() asm("func_001E0FE0");
s32 func_001E0FE8() asm("func_001E0FE8");
s32 func_001E1068() asm("func_001E1068");
s32 func_001E15A8() asm("func_001E15A8");
s32 func_001E1638() asm("func_001E1638");
s32 func_001E1698() asm("func_001E1698");
s32 func_001E16C0() asm("func_001E16C0");
void func_001E1728(void *arg0 = 0, ...) asm("func_001e1728");
void func_001e1728_impl(void *arg0) asm("func_001e1728");
void func_001e1728_impl(void *arg0) {
    u32 temp_t6;

    temp_t6 = (*(s32*)((s8*)arg0 + 0x24));
    switch (temp_t6) {
    case 0:
        func_001E0FE0();
        return;
