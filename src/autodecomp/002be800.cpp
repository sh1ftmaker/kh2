// coverage: addr=0x002be800 symbol=func_002be800 size=264 class=float source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:62.5;ghidra:near:31.68
...
// m2c raw+unkfix output for 0x002be800, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_002BE800 {
    /* 0x00 */ char pad0[0x30];
};                                                  /* size = 0x30 */

s32 func_002C5ED8() asm("func_002C5ED8");
s32 func_001050D8(s32 = 0) asm("func_001050D8");
s32 func_002BF468(s32 = 0, void * = 0, s32 = 0, f32 = 0) asm("func_002BF468");
s32 func_002C1AA0(s32 = 0, void * = 0, s32 = 0, f32 = 0) asm("func_002C1AA0");
s32 func_002C54C8(s32 = 0, void * = 0, s32 = 0, f32 = 0) asm("func_002C54C8");
s32 func_002BE800(void *arg0 = 0, s32 arg1 = 0, f32 fparg0 = 0, ...) asm("_ZN8worldmap3Obj6appearEPKN2YS8OBJENTRYERKN2kn7FVectorEf");
s32 func_002be800_impl(void *arg0, s32 arg1, f32 fparg0) asm("_ZN8worldmap3Obj6appearEPKN2YS8OBJENTRYERKN2kn7FVectorEf");
s32 func_002be800_impl(void *arg0, s32 arg1, f32 fparg0) {
    s32 temp_v0;
    s32 temp_v0_2;
    s32 temp_v0_3;
    s32 var_v0;
    ...
    temp_t6 = (*(s32*)((s8*)arg0 + 0x5));
    switch (temp_t6) {                              /* irregular */
    default:
        var_v0 = 0;
        return var_v0;
    case 0:
        temp_v0 = func_001050D8(0xB10);
        func_002BF468(temp_v0, arg0, arg1, fparg0);
        var_v0 = temp_v0;
        /* Duplicate return node #6. Try simplifying control flow for better match */
        return var_v0;
    case 3:
        temp_v0_2 = func_001050D8(0xA00);
        func_002C54C8(temp_v0_2, arg0, arg1, fparg0);
        var_v0 = temp_v0_2;
        /* Duplicate return node #6. Try simplifying control flow for better match */
        return var_v0;
    case 2:
        return func_002C5ED8();
    case 1:
        temp_v0_3 = func_001050D8(0xAF0);
        func_002C1AA0(temp_v0_3, arg0, arg1, fparg0);
        var_v0 = temp_v0_3;
        /* Duplicate return node #6. Try simplifying control flow for better match */
        return var_v0;
    }
