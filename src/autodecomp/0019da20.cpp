// coverage: addr=0x0019da20 symbol=func_0019da20 size=72 class=straight source=permute status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:99.89;m2c:near:96.56;lift:near:66.06
// coverage: addr=0x0019da20 symbol=func_0019da20 size=72 class=straight source=ghidra status=near fuzzy=99.89
// coverage-alternatives: m2c:near:96.56;lift:near:66.06
...
s32 FUN_00190128(...) asm("func_00190128");
s32 FUN_0019da20(...) asm("_ZN2YS5RECOM7releaseEv");
s32 FUN_001bc688(...) asm("_ZN2YS12COMMAND_SLOT5clearEv");

// Ghidra decompile of 0x0019da20, wrapped mechanically (ad/fallback.py)

void FUN_0019da20_impl(undefined4 *param_1,undefined4 param_2) asm("_ZN2YS5RECOM7releaseEv");
void FUN_0019da20_impl(undefined4 *param_1,undefined4 param_2) {
  *param_1 = param_2;
  *(undefined2 *)(param_1 + 1) = 0;
  FUN_001bc688(param_1 + 1);
  FUN_00190128(param_1 + 4);
  param_1[0x14] = 0;
  param_1[0xf] = 0;
