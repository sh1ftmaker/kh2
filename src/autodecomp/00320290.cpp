// coverage: addr=0x00320290 symbol=func_00320290 size=72 class=straight source=lift status=exact fuzzy=100.0
...
// 0x00320290 func_00320290
u32 func_00320290(u32 a0) asm("func_00320290");
u32 func_00320290(u32 a0) {
