// coverage: addr=0x001ad3e0 symbol=_ZN2YS15WINDOW_TUTORIAL4drawEv size=80 class=straight source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:near:54.9;e3:near:48.69;ghidra:near:0.0
...
extern "C" u32 func_001ac310(u32) asm("func_001ac310");
extern "C" void func_001acdc0(u32, u32, u32, u32, u32, u32) asm("func_001acdc0");

// 0x001ad3e0 YS::WINDOW_TUTORIAL::draw()
u32 lift_001ad3e0(u32 a0) asm("_ZN2YS15WINDOW_TUTORIAL4drawEv");
u32 lift_001ad3e0(u32 a0) {
    func_001acdc0(a0, *(u32*)&(((YS_WINDOW_TUTORIAL*)a0)->super_WINDOW_BASE.super_WINDOW.XPos), *(u32*)&(((YS_WINDOW_TUTORIAL*)a0)->super_WINDOW_BASE.super_WINDOW.YPos), *(u32*)&(((YS_WINDOW_TUTORIAL*)a0)->super_WINDOW_BASE.super_WINDOW.XPos) + (*(u32*)&(((YS_WINDOW_TUTORIAL*)a0)->super_WINDOW_BASE.super_WINDOW.MessageDraw.MaxSize.Width) >> 1), *(u32*)&(((YS_WINDOW_TUTORIAL*)a0)->super_WINDOW_BASE.super_WINDOW.YPos) + (*(u32*)&(((YS_WINDOW_TUTORIAL*)a0)->super_WINDOW_BASE.super_WINDOW.MessageDraw.MaxSize.Height) >> 1), 0x1b0);
    return func_001ac310(a0 + 0xb6c);
}
