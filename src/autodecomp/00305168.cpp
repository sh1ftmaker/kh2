// coverage: addr=0x00305168 symbol=func_00305168 size=92 class=branchy source=ghidra status=exact fuzzy=100.0
...
s32 FUN_00305168(...) asm("func_00305168");
s32 FUN_00305c68(...) asm("func_00305c68");
extern u32 DAT_00378ae4 asm("D_00378ae4");

// Ghidra decompile of 0x00305168, wrapped mechanically (ad/fallback.py)

long FUN_00305168_impl(int *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4) asm("func_00305168");
long FUN_00305168_impl(int *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4) {
  long lVar1;
  
  DAT_00378ae4 = 0;
  lVar1 = FUN_00305c68(param_2,param_3,param_4);
