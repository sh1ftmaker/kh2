// coverage: addr=0x002485c8 symbol=_ZN2Tz4MUMI8SetupSelEv size=340 class=loop source=twins status=exact fuzzy=100.0
...
extern "C" SeqInfoTableLayout D_00371e00 asm("D_00371e00");
extern "C" void* D_0035ed50 asm("D_0035ed50");
extern "C" void* D_0035ed54 asm("D_0035ed54");
extern "C" void* D_0035ed60 asm("D_0035ed60");
...
namespace Tz { class MUMI { public: u32 SetupSel(); }; }
// the definition MUST produce the symbol: _ZN2Tz4HBTE8SetupSelEv  (source: registry)
// original name (E3 debug build): Tz::HBTE::SetupSel()
...
/* Tz::HBTE::SetupSel() */
u32 Tz::MUMI::SetupSel() {
    int cur = 0;

    for (int i = 0; i < 2; i++) {
        if (D_00371e00.e[i].unk10 != 0) {
            cur = i;
        }
        SetItem_288d80(D_0035ed50, i, 0, 0, D_0035ed54, D_00371e00.e[i].unk12,
                       D_00371e00.e[i].unk00, D_00371e00.e[i].unk08);

        SelectItemLayout* p = GetItemPtr_2891b8(D_0035ed50, i);
        SetExOffset_288e08(D_0035ed50, i, GetParamCr_23aa78(p->seq), 0);
    ...
    SetCurrent_2891f0(D_0035ed50, cur, true, 0, 2);
    return SetMsg_2b4388(D_0035ed60, &D_00371e00.e[cur], 0);
}
}
