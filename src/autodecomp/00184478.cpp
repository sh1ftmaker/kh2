// coverage: addr=0x00184478 symbol=func_00184478 size=112 class=float source=permute status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:97.68;ghidra:near:60.9;lift:near:28.56
// coverage: addr=0x00184478 symbol=func_00184478 size=112 class=float source=m2c status=near fuzzy=97.68
// coverage-alternatives: ghidra:near:60.9;lift:near:28.56
...
// m2c valid-syntax output for 0x00184478, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_00184478 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

s32 func_00184478(void *arg0 = 0, ...) asm("func_00184478");
s32 func_00184478_impl(void *arg0) asm("func_00184478");
s32 func_00184478_impl(void *arg0) {
    s32 var_s1;
    s32 var_v0;

    var_s1 = (s32)(0);
    if (M2C_FIELD(M2C_FIELD(arg0, void **, 0), s32 (**)(), 0x40)() != 0) {
        if ((M2C_FIELD(arg0, f32 *, 0x840) != M2C_FIELD(arg0, f32 *, 0x540)) || (var_v0 = 0, (M2C_FIELD(arg0, f32 *, 0x848) != M2C_FIELD(arg0, f32 *, 0x548)))) {
            var_s1 = 1;
        }
    } else {
block_4:
        return var_v0 = var_s1;
    }
            goto block_4;
}
