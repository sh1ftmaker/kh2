// coverage: addr=0x002a7588 symbol=_ZN2Tz8JmSynthe11ReadMixDataEv size=56 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: e3:near:99.36;lift:near:98.57;m2c:near:53.88
...
s32 FUN_00170518(...) asm("func_00170518");
s32 FUN_00253b30(...) asm("func_00253b30");
s32 FUN_002a7588(...) asm("_ZN2Tz8JmSynthe11ReadMixDataEv");
s32 FUN_002b64c8(...) asm("func_002b64c8");

// Ghidra decompile of 0x002a7588, wrapped mechanically (ad/fallback.py)

void FUN_002a7588_impl(void) asm("_ZN2Tz8JmSynthe11ReadMixDataEv");
void FUN_002a7588_impl(void) {
  undefined8 uVar1;
  undefined1 auStack_90 [128];
  
  uVar1 = FUN_002b64c8();
  FUN_00253b30(auStack_90,uVar1);
  FUN_00170518(auStack_90,0x13ee,0);
  return;
}
