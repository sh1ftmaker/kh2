// coverage: addr=0x001ce2a0 symbol=_Z16wtarget_001ce2a0jjjj size=56 class=branchy source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:73.53;m2c:near:58.68
...
s32 FUN_001ce2a0(...) asm("_Z16wtarget_001ce2a0jjjj");

// Ghidra decompile of 0x001ce2a0, wrapped mechanically (ad/fallback.py)

int FUN_001ce2a0_impl(int *param_1,int param_2,int param_3) asm("_Z16wtarget_001ce2a0jjjj");
int FUN_001ce2a0_impl(int *param_1,int param_2,int param_3) {
  int iVar1;
  
  if ((*param_1 <= param_2) || (param_1[param_2 + 1] == 0)) {
    param_2 = param_3;
  }
  iVar1 = (int)param_1 + param_1[param_2 + 1];
