// coverage: addr=0x00236bb8 symbol=func_00236bb8 size=124 class=float source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:92.52;ghidra:near:81.74
...
// m2c raw+unkfix output for 0x00236bb8, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_00236BB8 {
    /* 0x00 */ char pad0[0x30];
};                                                  /* size = 0x30 */

s32 func_002367C8(s32 = 0) asm("func_002367C8");
s32 func_002368E8(s32 = 0, f32 = 0) asm("func_002368E8");
void func_00236BB8(void *arg0 = 0, f32 fparg0 = 0, ...) asm("func_00236bb8");
void func_00236bb8_impl(void *arg0, f32 fparg0) asm("func_00236bb8");
void func_00236bb8_impl(void *arg0, f32 fparg0) {
    s32 var_s1;
    s32 var_s2;
    ...
    if ((*(s32*)((s8*)arg0 + 0x10)) > 0) {
        ...
        do {
            var_s2 += 1;
            func_002368E8((*(s32*)((s8*)arg0 + 0x14)) + var_s1, fparg0);
            func_002367C8((*(s32*)((s8*)arg0 + 0x14)) + var_s1);
            var_s1 += 0x1A0;
        } while (var_s2 < (*(s32*)((s8*)arg0 + 0x10)));
    }
}
