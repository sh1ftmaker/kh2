// coverage: addr=0x00171518 symbol=func_00171518 size=76 class=branchy source=twins status=exact fuzzy=100.0
...
void func_00171518_impl(u32 a0) asm("_ZN2YS12trap_obj_dirEP8BD_VALUE");
void func_00171518_impl(u32 a0) {
    u32 s0 = a0;
    kn::FVector tmp;
    func_0016af58((u32)&tmp, *(u32*)((u32)*(u32*)((u32)a0 + (s32)(0)) + (s32)(4)));
