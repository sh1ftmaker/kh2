// coverage: addr=0x001574f8 symbol=_Z16wtarget_001574f8jjjj size=200 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:88.62;ghidra:near:67.07
...
// m2c raw+unkfix output for 0x001574f8, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_001574F8 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

s32 func_002BA368() asm("func_002BA368");
s32 func_00138C10(void * = 0, s32 = 0) asm("func_00138C10");
s32 func_001543A0(void * = 0, s32 = 0, s32 = 0) asm("func_001543A0");
s32 func_00155D58(void * = 0, s32 = 0) asm("func_00155D58");
s32 func_00157990() asm("_ZN2dk12GAUGE_PLAYER10checkHPoldEv");
s32 func_001581A8(void * = 0) asm("func_001581A8");
s32 func_002BA358() asm("func_002BA358");
void func_001574F8(void *arg0 = 0, s32 arg1 = 0, ...) asm("_Z16wtarget_001574f8jjjj");
void func_001574f8_impl(void *arg0, s32 arg1) asm("_Z16wtarget_001574f8jjjj");
void func_001574f8_impl(void *arg0, s32 arg1) {
    void *temp_s2;

    func_00157990();
    temp_s2 = arg0 + 0x1A30;
    func_00138C10(temp_s2, arg1);
    (*(s32*)((s8*)temp_s2 + 0x188)) = func_00155D58(arg0, 0);
    func_00138C10(arg0 + 0x1BCC, func_00155D58(arg0, 1));
    func_00138C10(arg0 + 0x20A0, func_00155D58(arg0, 2));
    func_001543A0(arg0 + 0x40, 1, (*(s32*)((s8*)arg0 + 0x18)));
    if ((func_001581A8(arg0) != 0) && (func_002BA358() == 0)) {
        func_002BA368();
    }
}
