// coverage: addr=0x0016e200 symbol=func_0016e200 size=60 class=branchy source=twins status=exact fuzzy=100.0
// coverage-alternatives: lift:near:85.27;m2c:near:85.27;ghidra:near:66.0
...
void func_0016e200_impl(BD_VALUE* param_1) asm("_ZN2YS19trap_effect_set_rotEP8BD_VALUE");
void func_0016e200_impl(BD_VALUE* param_1) {
    kn::FVector* dst = (kn::FVector*)(u32)func_001dc648(param_1[0].u);
