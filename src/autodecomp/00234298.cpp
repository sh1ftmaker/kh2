// coverage: addr=0x00234298 symbol=_Z16wtarget_00234298jjjj size=88 class=straight source=lift status=exact fuzzy=100.0
...
// 0x00234298 wtarget_00234298(unsigned int, unsigned int, unsigned int, unsigned int)
u32 lift_00234298(u32 a0, u32 a1, u32 a2, u32 a3) asm("_Z16wtarget_00234298jjjj");
u32 lift_00234298(u32 a0, u32 a1, u32 a2, u32 a3) {
    u32 t6;
    u32 t3;
    t6 = *(u32*)(&D_0035e360);
    t3 = *(u32*)(&D_0035e368);
    *(u32*)(((t6 << 5) + (u32)&D_01dadc00)) = 6;
