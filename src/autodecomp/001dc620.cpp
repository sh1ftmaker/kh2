// coverage: addr=0x001dc620 symbol=_ZN3ryj6EFFECT5scaleEv size=40 class=straight source=typed status=exact fuzzy=100.0
...
extern "C" u32 func_001e6cd8(u32) asm("func_001e6cd8");
extern "C" void func_001dc9e0(u32) asm("func_001dc9e0");

// 0x001dc620 ryj::EFFECT::scale()
u32 lift_001dc620(u32 a0) asm("_ZN3ryj6EFFECT5scaleEv");
u32 lift_001dc620(u32 a0) {
    func_001dc9e0(a0);
    return func_001e6cd8(*(u32*)&(((ryj_EFFECT*)a0)->PartMng));
}
