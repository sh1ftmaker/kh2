// coverage: addr=0x0015ae00 symbol=_ZN2dk24BILLBOARD_DISABLE_REASON6updateEv size=164 class=float source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:near:79.78;e3:near:65.54;ghidra:near:9.29
...
struct dk_BILLBOARD_DISABLE_REASON;
union TASK_ARGS;
...
struct dk_BILLBOARD_DISABLE_REASON {  // class dk::BILLBOARD_DISABLE_REASON size=0x1c0
...
extern "C" u32 func_001390a8(u32) asm("func_001390a8");
extern "C" u32 func_00197920(u32) asm("func_00197920");
extern "C" void func_00138c10(u32, u32) asm("func_00138c10");

// 0x0015ae00 dk::BILLBOARD_DISABLE_REASON::update()
// minilink-rodata 0x0036b3ac   (float literals live here in the original)
void lift_0015ae00(u32 a0) asm("_ZN2dk24BILLBOARD_DISABLE_REASON6updateEv");
void lift_0015ae00(u32 a0) {
    f32 f1;
    f32 f0;
    if (((s32)(func_00197920(a0)) != 0)) {
        ...
        f1 = *(f32*)&(((dk_BILLBOARD_DISABLE_REASON*)a0)->m_time);
        if ((f1 <= 0.0f)) {
            func_00138c10(a0, 0x30);
            *(f32*)&(((dk_BILLBOARD_DISABLE_REASON*)a0)->m_time) = 20000.0f;
            f1 = 20000.0f;
        }
        if (!((f1 == 20000.0f))) {
            f0 = *(f32*)(&D_00349e14);
            *(f32*)&(((dk_BILLBOARD_DISABLE_REASON*)a0)->m_time) = (f1 - f0);
        }
        func_001390a8(a0);
        return;
    }
