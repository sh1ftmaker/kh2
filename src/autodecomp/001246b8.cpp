// coverage: addr=0x001246b8 symbol=_ZN2kn10ModelMulti12drawOnShadowEPNS_16ProjectionCameraEPPN3Axa11DMA_SET_TAGEPNS_9DrawParamEPcbPNS_7FMatrixE size=140 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:75.31;m2c:near:29.17;e3:near:0.0
...
s32 FUN_001246b8(...) asm("_ZN2kn10ModelMulti12drawOnShadowEPNS_16ProjectionCameraEPPN3Axa11DMA_SET_TAGEPNS_9DrawParamEPcbPNS_7FMatrixE");
s32 FUN_00124748(...) asm("func_00124748");

// Ghidra decompile of 0x001246b8, wrapped mechanically (ad/fallback.py)

void FUN_001246b8_impl(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4, undefined8 param_5,undefined1 param_6,undefined8 param_7) asm("_ZN2kn10ModelMulti12drawOnShadowEPNS_16ProjectionCameraEPPN3Axa11DMA_SET_TAGEPNS_9DrawParamEPcbPNS_7FMatrixE");
void FUN_001246b8_impl(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4, undefined8 param_5,undefined1 param_6,undefined8 param_7) {
  undefined8 uVar1;
  
  uVar1 = FUN_00124748(param_1,0);
  (**(code **)(*(int *)uVar1 + 0x58))(uVar1,param_2,param_3,param_4,param_5,param_6,param_7);
  return;
}
