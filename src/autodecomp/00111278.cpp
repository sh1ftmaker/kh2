// coverage: addr=0x00111278 symbol=func_00111278 size=44 class=branchy source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:exact:100.0;lift:near:25.73
...
s32 FUN_00111278(...) asm("func_00111278");

// Ghidra decompile of 0x00111278, wrapped mechanically (ad/fallback.py)

undefined4 FUN_00111278_impl(int param_1) asm("func_00111278");
undefined4 FUN_00111278_impl(int param_1) {
  int iVar1;
  undefined4 uVar2;
  
  iVar1 = *(int *)(param_1 + 0xb6c);
  if (((iVar1 == 0x10) || (iVar1 == 0xc)) || (uVar2 = 0, iVar1 == 0xf)) {
    uVar2 = 1;
  }
  return uVar2;
}
