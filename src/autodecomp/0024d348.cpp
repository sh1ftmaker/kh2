// coverage: addr=0x0024d348 symbol=_ZN2Tz4TTPT8SetupSelEv size=340 class=loop source=twins status=exact fuzzy=100.0
...
extern "C" SeqInfoTableLayout D_00372298 asm("D_00372298");
extern "C" void* D_0035edd0 asm("D_0035edd0");
extern "C" void* D_0035edd4 asm("D_0035edd4");
extern "C" void* D_0035edec asm("D_0035edec");
...
namespace Tz { class TTPT { public: u32 SetupSel(); }; }
// the definition MUST produce the symbol: _ZN2Tz4HBTE8SetupSelEv  (source: registry)
// original name (E3 debug build): Tz::HBTE::SetupSel()
...
/* Tz::HBTE::SetupSel() */
u32 Tz::TTPT::SetupSel() {
    int cur = 0;

    for (int i = 0; i < 2; i++) {
        if (D_00372298.e[i].unk10 != 0) {
            cur = i;
        }
        SetItem_288d80(D_0035edd0, i, 0, 0, D_0035edd4, D_00372298.e[i].unk12,
                       D_00372298.e[i].unk00, D_00372298.e[i].unk08);

        SelectItemLayout* p = GetItemPtr_2891b8(D_0035edd0, i);
        SetExOffset_288e08(D_0035edd0, i, GetParamCr_23aa78(p->seq), 0);
    ...
    SetCurrent_2891f0(D_0035edd0, cur, true, 0, 2);
    return SetMsg_2b4388(D_0035edec, &D_00372298.e[cur], 0);
}
}
