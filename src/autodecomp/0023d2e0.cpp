// coverage: addr=0x0023d2e0 symbol=func_0023d2e0 size=32 class=straight source=ghidra status=exact fuzzy=100.0
...
s32 FUN_0023d2e0(...) asm("_ZN2Tz10MenuCommon17GetLastAccessSlotERi");
extern u32 DAT_0035eb48 asm("D_0035eb48");

// Ghidra decompile of 0x0023d2e0, wrapped mechanically (ad/fallback.py)

bool FUN_0023d2e0_impl(int *param_1) asm("_ZN2Tz10MenuCommon17GetLastAccessSlotERi");
bool FUN_0023d2e0_impl(int *param_1) {
  bool bVar1;
  int iVar2;
  
  bVar1 = DAT_0035eb48 == -1;
  iVar2 = DAT_0035eb48;
  if (bVar1) {
    iVar2 = 0;
  }
