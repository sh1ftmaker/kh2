// coverage: addr=0x001efd38 symbol=_Z16wtarget_001efd38jjjj size=36 class=float source=corpus status=exact fuzzy=100.0
...
void twin__Z16wtarget_001efd38jjjj(pppPObject* pobj, pppCtrlTable* ctbl) asm("_Z16wtarget_001efd38jjjj");
void twin__Z16wtarget_001efd38jjjj(pppPObject* pobj, pppCtrlTable* ctbl) {
