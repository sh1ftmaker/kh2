// coverage: addr=0x00321910 symbol=func_00321910 size=72 class=straight source=lift status=exact fuzzy=100.0
...
// 0x00321910 func_00321910
u32 func_00321910(u32 a0) asm("func_00321910");
u32 func_00321910(u32 a0) {
