// coverage: addr=0x0031d8a0 symbol=func_0031d8a0 size=84 class=straight source=lift status=exact fuzzy=100.0
...
extern "C" u32 D_0034aad8 asm("D_0034aad8");
extern "C" u32 func_00239870(u32) asm("func_00239870");
extern "C" void func_002361d0(u32) asm("func_002361d0");

// 0x0031d8a0 func_0031d8a0
u32 func_0031d8a0(u32 a0) asm("func_0031d8a0");
u32 func_0031d8a0(u32 a0) {
    u32 v0;
    *(u32*)(a0) = (u32)&D_0034aad8;
