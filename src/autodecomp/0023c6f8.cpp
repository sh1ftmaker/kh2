// coverage: addr=0x0023c6f8 symbol=func_0023c6f8 size=48 class=straight source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:exact:100.0;e3:near:72.83;ghidra:near:66.79
...
extern "C" u32 func_0023c598(u32) asm("func_0023c598");
extern "C" void func_0023c728(u32) asm("func_0023c728");

// 0x0023c6f8 func_0023c6f8
u32 func_0023c6f8(u32 a0) asm("func_0023c6f8");
u32 func_0023c6f8(u32 a0) {
    func_0023c728(a0);
    *(u32*)&(((YI_LAYOUT*)a0)->phase) = 1;
    return func_0023c598(a0);
}
