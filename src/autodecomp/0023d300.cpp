// coverage: addr=0x0023d300 symbol=func_0023d300 size=32 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:56.62;lift:near:50.0
...
s32 FUN_0023d300(...) asm("_ZN2Tz10MenuCommon17GetLastAccessDataERi");
extern u32 DAT_0035eb4c asm("D_0035eb4c");

// Ghidra decompile of 0x0023d300, wrapped mechanically (ad/fallback.py)

bool FUN_0023d300_impl(int *param_1) asm("_ZN2Tz10MenuCommon17GetLastAccessDataERi");
bool FUN_0023d300_impl(int *param_1) {
  bool bVar1;
  int iVar2;
  
  bVar1 = DAT_0035eb4c == -1;
  iVar2 = DAT_0035eb4c;
  if (bVar1) {
    iVar2 = 0;
  }
