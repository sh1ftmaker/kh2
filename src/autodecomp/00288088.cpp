// coverage: addr=0x00288088 symbol=_ZN2Tz8MenuBase13isPressAnyKeyEv size=44 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: e3:near:99.55;lift:near:81.82;m2c:near:39.0
...
s32 FUN_00167f18(...) asm("func_00167f18");
s32 FUN_00288088(...) asm("_ZN2Tz8MenuBase13isPressAnyKeyEv");

// Ghidra decompile of 0x00288088, wrapped mechanically (ad/fallback.py)

bool FUN_00288088_impl(void) asm("_ZN2Tz8MenuBase13isPressAnyKeyEv");
bool FUN_00288088_impl(void) {
  int iVar1;
  
  iVar1 = FUN_00167f18(0);
  return *(long *)(iVar1 + 8) != 0;
}
