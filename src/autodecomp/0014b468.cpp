// coverage: addr=0x0014b468 symbol=func_0014b468 size=72 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:45.56;m2c:near:43.06;e3:near:18.06
...
s32 FUN_0014b468(...) asm("func_0014b468");
s32 FUN_0014b5e8(...) asm("func_0014b5e8");

// Ghidra decompile of 0x0014b468, wrapped mechanically (ad/fallback.py)

void FUN_0014b468_impl(undefined8 param_1,uint param_2,uint param_3) asm("func_0014b468");
void FUN_0014b468_impl(undefined8 param_1,uint param_2,uint param_3) {
  FUN_0014b5e8(param_1,0x80008,
               (long)(int)((param_2 & 0xffff) * 0x10 + 8) |
               (long)(int)((param_3 & 0xffff) * 0x10 + 8) << 0x10);
  return;
}
