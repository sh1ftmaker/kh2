// coverage: addr=0x00313e80 symbol=func_00313e80 size=88 class=straight source=corpus status=exact fuzzy=100.0
...
int func_00313e80_impl(long long a0, long long a1) asm("func_00313e80");
int func_00313e80_impl(long long a0, long long a1) {
    struct s20 b00;
    struct s20 b20;
    struct s20 b40;
    func_003147a0(&a0, &b00);
    func_003147a0(&a1, &b20);
    return func_003146c8(func_00313c58(&b00, &b20, &b40));
}
