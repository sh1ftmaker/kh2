// coverage: addr=0x0028d660 symbol=func_0028d660 size=132 class=branchy source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:near:98.18;ghidra:near:83.16;e3:near:40.41
...
struct Tz_LightCur {  // class Tz::LightCur size=0x1c0
    dk_Sprite super_Sprite;                            // +0x0
    s16 m_SeqNum[3];                                   // +0x196
    s8 m_InitParent;                                   // +0x19c
    s8 m_SetParent;                                    // +0x19d
    f32 m_Time;                                        // +0x19e
    Tz_PosXY m_FromPos;                                // +0x1a2
    Tz_PosXY m_ToPos;                                  // +0x1aa
    Tz_PosXY m_NowPos;                                 // +0x1b2
};
...
extern "C" u32 func_0028d6e8(u32, u32) asm("func_0028d6e8");
extern "C" u32 func_0031a260(u32, u32) asm("func_0031a260");

// 0x0028d660 func_0028d660
u32 func_0028d660(u32 a0, u32 a1) asm("func_0028d660");
u32 func_0028d660(u32 a0, u32 a1) {
    u32 v0;
    u32 v0_0;
    u32 v0_1;
    v0 = func_0028d6e8(a0, a1);
    if ((*(u32*)&(((Tz_LightCur*)a0)->super_Sprite.m_parent) != a1)) {
        *(u32*)&(((Tz_LightCur*)a0)->super_Sprite.m_parent) = a1;
        *(u8*)((a0 + 0x19d)) = 1;
        v0_0 = func_001396b0(a0);
        if (((s32)(*(u32*)&(((Tz_LightCur*)a0)->super_Sprite.m_parent)) != 0)) {
            *(u32*)&(((Tz_LightCur*)a0)->super_Sprite.m_ParentSeq) = 0;
            v0_1 = func_001396b0(a0);
            if (((s32)(*(u32*)&(((Tz_LightCur*)a0)->super_Sprite.m_ParentSeq)) != 0)) {
                return func_0031a260(a0, 0);
            } else {
                return v0_1;
            }
        } else {
