// coverage: addr=0x0011e410 symbol=func_0011e410 size=64 class=straight source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:near:97.69;ghidra:near:77.5
...
extern "C" u32 func_0011e450(u32, u32) asm("func_0011e450");
extern "C" void func_0011e350(u32, u32) asm("func_0011e350");

// 0x0011e410 func_0011e410
u32 func_0011e410(u32 a0, u32 a1) asm("func_0011e410");
u32 func_0011e410(u32 a0, u32 a1) {
    func_0011e350(a0, *(u32*)&(((kn_ModelObj*)a0)->anmWork_));
    *(u32*)&(((kn_ModelObj*)a0)->anmWork_) = 0;
    return func_0011e450(a0, a1);
}
