// coverage: addr=0x0021ead0 symbol=func_0021ead0 size=128 class=float source=corpus status=exact fuzzy=100.0
// coverage-alternatives: lift:near:33.24;ghidra:near:15.63;m2c:near:8.44
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/stdProg/pppGetRotMatrixZ.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/stdProg/pppGetRotMatrixZ.c"
...
# 2 "/data/agent-tom/kh2/corpus/kh1/src/ppp/stdProg/pppGetRotMatrixZ.c" 2

void pppGetRotMatrixZ(sceVu0FMATRIX mp, u32 angle);



void func_0021ead0_impl(sceVu0FMATRIX mp, u32 angle) asm("func_0021ead0");
void func_0021ead0_impl(sceVu0FMATRIX mp, u32 angle) {
