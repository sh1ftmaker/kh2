// coverage: addr=0x001d2130 symbol=func_001d2130 size=76 class=float source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:near:50.65;ghidra:near:46.43;e3:near:31.26
...
extern "C" u32 func_001d2248(u32, u32) asm("func_001d2248");
extern "C" void func_001d2110(u32, u32, f32) asm("func_001d2110");

// 0x001d2130 func_001d2130
u32 func_001d2130(u32 a0, u32 a1, f32 fa0) asm("func_001d2130");
u32 func_001d2130(u32 a0, u32 a1, f32 fa0) {
    u32 v0;
    func_001d2110(a0, *(u32*)&(((YS_COMBOCOUNTER*)a0)->super_MISSION_COUNT.Value) + a1, fa0);
    v0 = func_001d2248(a0, *(u32*)&(((YS_COMBOCOUNTER*)a0)->super_MISSION_COUNT.Value));
    *(f32*)&(((YS_COMBOCOUNTER*)a0)->Time) = fa0;
    return v0;
}
