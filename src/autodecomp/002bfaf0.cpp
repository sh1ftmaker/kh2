// coverage: addr=0x002bfaf0 symbol=func_002bfaf0 size=80 class=straight source=lift status=exact fuzzy=100.0
...
// 0x002bfaf0 func_002bfaf0
u32 func_002bfaf0() asm("func_002bfaf0");
u32 func_002bfaf0() {
    *(u32*)(&D_00361a50) = 0;
    func_001c11a8(0xc);
