// coverage: addr=0x00323408 symbol=func_00323408 size=308 class=loop source=m2c status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:94.35;lift:near:75.57
...
// m2c raw+unkfix output for 0x00323408, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_00323408 {
    /* 0x00 */ char pad0[0x40];
};                                                  /* size = 0x40 */
...
void func_00323408(void *arg0 = 0, ...) asm("func_00323408");
void func_00323408_impl(void *arg0) asm("func_00323408");
void func_00323408_impl(void *arg0) {
    s32 var_s1;
    s32 var_s1_2;
    s32 var_s1_3;
    void *var_s0;
