// coverage: addr=0x00304f50 symbol=func_00304f50 size=92 class=branchy source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: corpus:near:85.87;lift:near:66.65;m2c:near:58.7
...
s32 FUN_00304f50(...) asm("func_00304f50");
s32 FUN_00305be8(...) asm("func_00305be8");
extern u32 DAT_00378ae4 asm("D_00378ae4");

// Ghidra decompile of 0x00304f50, wrapped mechanically (ad/fallback.py)

long FUN_00304f50_impl(int *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4) asm("func_00304f50");
long FUN_00304f50_impl(int *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4) {
  long lVar1;
  
  DAT_00378ae4 = 0;
  lVar1 = FUN_00305be8(param_2,param_3,param_4);
  if ((lVar1 == -1) && (DAT_00378ae4 != 0)) {
    *param_1 = DAT_00378ae4;
  }
  return lVar1;
}
