// coverage: addr=0x001ac1d0 symbol=func_001ac1d0 size=52 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:95.38;lift:near:78.21
...
// m2c raw output for 0x001ac1d0, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_001AC1D0 {
    /* 0x00 */ char pad0[0x10];
};                                                  /* size = 0x10 */

s32 func_00239D10(s32 = 0) asm("func_00239D10");
s32 func_001AC1D0(u8 *arg0 = 0, ...) asm("func_001ac1d0");
s32 func_001ac1d0_impl(u8 *arg0) asm("func_001ac1d0");
s32 func_001ac1d0_impl(u8 *arg0) {
    s32 var_v0;

    var_v0 = 0;
    if (*arg0 != 0) {
        var_v0 = func_00239D10(arg0 + 4) != 0;
    }
    return var_v0;
}
