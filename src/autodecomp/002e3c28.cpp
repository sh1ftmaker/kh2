// coverage: addr=0x002e3c28 symbol=func_002e3c28 size=68 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:49.88;lift:near:34.84
...
// m2c valid-syntax output for 0x002e3c28, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_002E3C28 {
    /* 0x00 */ char pad0[0x10];
};                                                  /* size = 0x10 */

M2C_UNK func_002CC620(s32, void *, s32) asm("func_002CC620");
void func_002E3C28(void *arg0 = 0, ...) asm("_ZN2Ti20trap_reset_leave_wayEP8BD_VALUE");
void func_002e3c28_impl(void *arg0) asm("_ZN2Ti20trap_reset_leave_wayEP8BD_VALUE");
void func_002e3c28_impl(void *arg0) {
    s32 temp_a0;
    s32 temp_a2;
    void *temp_a1;

    temp_a1 = M2C_FIELD(M2C_FIELD(arg0, void **, 0), void **, 4);
    temp_a2 = M2C_FIELD(M2C_FIELD(arg0, void **, 4), s32 *, 4);
    if (temp_a1 != NULL) {
        temp_a0 = M2C_FIELD(temp_a1, s32 *, 0x508);
        if (temp_a0 != 0) {
            if (temp_a2 != 0) {
                func_002CC620(temp_a0, temp_a1, temp_a2);
            }
        }
    }
}
