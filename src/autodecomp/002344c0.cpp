// coverage: addr=0x002344c0 symbol=func_002344c0 size=92 class=straight source=lift status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:59.86;ghidra:near:35.13
...
// 0x002344c0 func_002344c0
u32 func_002344c0(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4) asm("func_002344c0");
u32 func_002344c0(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4) {
    u32 t6;
    u32 t3;
    t6 = *(u32*)(&D_0035e360);
    t3 = *(u32*)(&D_0035e368);
    *(u32*)(((t6 << 5) + (u32)&D_01dadc00)) = 9;
