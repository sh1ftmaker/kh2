// coverage: addr=0x00323e98 symbol=func_00323e98 size=320 class=loop source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:exact:100.0;lift:near:71.01
...
extern undefined *PTR_LAB_00347e60 asm("D_00347e60");
extern undefined *PTR_LAB_00347f98 asm("D_00347f98");

// Ghidra decompile of 0x00323e98, wrapped mechanically (ad/fallback.py)

void FUN_00323e98_impl(int param_1) asm("func_00323e98");
void FUN_00323e98_impl(int param_1) {
  undefined4 *puVar1;
  int iVar2;
  ...
  iVar2 = 4;
  do {
    *puVar1 = &PTR_LAB_00347f98;
    iVar2 = iVar2 + -1;
    FUN_0031a838(puVar1 + 3);
    *puVar1 = &PTR_LAB_00347e60;
    FUN_00239700(puVar1 + 6);
    *puVar1 = &PTR_LAB_00347e40;
    puVar1[0x66] = 0;
    puVar1 = puVar1 + 0x6d;
  } while (iVar2 != -1);
  ...
  puVar1 = (undefined4 *)(param_1 + 0x110c);
  iVar2 = 0xe;
  do {
    *puVar1 = &PTR_LAB_00347f98;
    iVar2 = iVar2 + -1;
