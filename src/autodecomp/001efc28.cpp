// coverage: addr=0x001efc28 symbol=func_001efc28 size=32 class=straight source=corpus status=exact fuzzy=100.0
// coverage-alternatives: lift:near:73.5;m2c:near:73.5;ghidra:near:73.38
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppAngMoveLoop.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppAngMoveLoop.c"
...
# 2 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppAngMoveLoop.c" 2
...
void func_001efc28_impl(pppPObject* pobj, pppCtrlTable* ctbl) asm("func_001efc28");
void func_001efc28_impl(pppPObject* pobj, pppCtrlTable* ctbl) {
