// coverage: addr=0x00173dc0 symbol=func_00173dc0 size=76 class=branchy source=twins status=exact fuzzy=100.0
...
void func_00173dc0_impl(u32 a0) asm("_ZN2YS19trap_obj_target_posEP8BD_VALUE");
void func_00173dc0_impl(u32 a0) {
    u32 s0 = a0;
    kn::FVector tmp;
    func_0016bda8((u32)&tmp, *(u32*)((u32)*(u32*)((u32)a0 + (s32)(0)) + (s32)(4)));
