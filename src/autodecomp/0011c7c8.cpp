// coverage: addr=0x0011c7c8 symbol=func_0011c7c8 size=48 class=straight source=typed status=exact fuzzy=100.0
...
// 0x0011c7c8 func_0011c7c8
void func_0011c7c8(u32 a0, u32 a1) asm("func_0011c7c8");
void func_0011c7c8(u32 a0, u32 a1) {
    ((void(*)(u32, u32, u32))(*(u32*)((*(u32*)(*(u32*)&(((kn_ModelObj*)a0)->model_)) + 0x3c))))(*(u32*)&(((kn_ModelObj*)a0)->model_), *(u32*)((a0 + 0x104)), a1);
}
