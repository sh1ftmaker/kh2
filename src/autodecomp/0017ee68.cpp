// coverage: addr=0x0017ee68 symbol=func_0017ee68 size=124 class=branchy source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;ghidra:exact:100.0;m2c:exact:100.0;e3:near:34.38
...
extern "C" void func_00127c70(u32, u32, u32) asm("func_00127c70");

// 0x0017ee68 func_0017ee68
void func_0017ee68(u32 a0) asm("func_0017ee68");
void func_0017ee68(u32 a0) {
    u32 s1;
    s1 = *(u32*)((*(u32*)&(((kn_ModelObj*)a0)->flag_) + 0x670));
    if (((s32)(*(u32*)&(((kn_ModelObj*)a0)->prj_cam_root_.m_Projection.aspect_[1])) != 0)) {
        func_00127c70(s1, func_001050c8(), *(u32*)&(((kn_ModelObj*)a0)->prj_cam_root_.m_Projection.aspect_[1]));
        *(u32*)&(((kn_ModelObj*)a0)->prj_cam_root_.m_Projection.aspect_[1]) = 0;
    }
    if ((*(u32*)&(((kn_ModelObj*)a0)->prj_cam_root_.m_Projection.aspect_[2]) != 0)) {
        func_00127c70(s1, func_001050c8(), *(u32*)&(((kn_ModelObj*)a0)->prj_cam_root_.m_Projection.aspect_[2]));
        *(u32*)&(((kn_ModelObj*)a0)->prj_cam_root_.m_Projection.aspect_[2]) = 0;
    }
    return;
}
