// coverage: addr=0x001fab08 symbol=func_001fab08 size=60 class=straight source=corpus status=exact fuzzy=100.0
// coverage-alternatives: m2c:exact:100.0;lift:near:86.67;ghidra:near:69.27
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/keProg/pppKeLnsClm.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/keProg/pppKeLnsClm.c"
...
void func_0021fa10(KeLnsClm*);
void KeLnsArnd_Init(KeLnsArnd*);
void KeLnsCrn_Init(KeLnsCrn*);
void KeLnsFls_Init(KeLnsFls*);
# 2 "/data/agent-tom/kh2/corpus/kh1/src/ppp/keProg/pppKeLnsClm.c" 2
...
void func_001fab08_impl(pppPObject* pobj, pppCtrlTable* ctbl) asm("func_001fab08");
void func_001fab08_impl(pppPObject* pobj, pppCtrlTable* ctbl) {
