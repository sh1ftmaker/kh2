// coverage: addr=0x001fba88 symbol=func_001fba88 size=36 class=straight source=corpus status=exact fuzzy=100.0
...
void func_001fba88_impl(pppPObject* pobj, pppCtrlTable* ctbl) asm("func_001fba88");
void func_001fba88_impl(pppPObject* pobj, pppCtrlTable* ctbl) {
