// coverage: addr=0x002bdac8 symbol=func_002bdac8 size=144 class=loop source=lift status=exact fuzzy=100.0
...
// 0x002bdac8 func_002bdac8
u32 func_002bdac8(u32 a0) asm("func_002bdac8");
u32 func_002bdac8(u32 a0) {
    u32 a0_0;
    u32 s0;
    u32 v0;
    func_002be148(a0);
