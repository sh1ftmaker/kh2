// coverage: addr=0x001efb18 symbol=_Z16wtarget_001efb18jjjj size=36 class=float source=corpus status=exact fuzzy=100.0
// coverage-alternatives: lift:near:55.0;m2c:near:39.44;ghidra:near:33.33
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppAccele.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppAccele.c"
...
# 2 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppAccele.c" 2
...
void twin__Z16wtarget_001efb18jjjj(pppPObject* pobj, pppCtrlTable* ctbl) asm("_Z16wtarget_001efb18jjjj");
void twin__Z16wtarget_001efb18jjjj(pppPObject* pobj, pppCtrlTable* ctbl) {
