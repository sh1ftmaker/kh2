// coverage: addr=0x0031ebb0 symbol=func_0031ebb0 size=72 class=straight source=lift status=exact fuzzy=100.0
...
// 0x0031ebb0 func_0031ebb0
u32 func_0031ebb0(u32 a0) asm("func_0031ebb0");
u32 func_0031ebb0(u32 a0) {
