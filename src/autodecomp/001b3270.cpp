// coverage: addr=0x001b3270 symbol=_ZN2YS6OBJOCC11disable_allEv size=84 class=loop source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:95.45;m2c:near:88.29;e3:near:40.86
...
s32 FUN_001b3270(...) asm("_ZN2YS6OBJOCC11disable_allEv");

// Ghidra decompile of 0x001b3270, wrapped mechanically (ad/fallback.py)

void FUN_001b3270_impl(int *param_1) asm("_ZN2YS6OBJOCC11disable_allEv");
void FUN_001b3270_impl(int *param_1) {
  int iVar1;
  int iVar2;
  int iVar3;
  
  if ((*param_1 != 0) && (iVar2 = 0, 0 < *(int *)(*param_1 + 4))) {
    iVar3 = 0;
    do {
      iVar2 = iVar2 + 1;
      iVar1 = *(int *)(iVar3 + param_1[1] + 0x80);
