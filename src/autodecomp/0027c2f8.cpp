// coverage: addr=0x0027c2f8 symbol=func_0027c2f8 size=192 class=branchy source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:74.54;m2c:near:64.27
...
s32 FUN_00257070(...) asm("_ZN2Tz5CmTop9GetCurPosEi");
s32 FUN_00257088(...) asm("_ZN2Tz5CmTop12GetCurTopPosEi");
s32 FUN_0027c2f8(...) asm("_ZN2Tz9CmAbility16AdjustInitCurPosEv");
s32 FUN_002891f0(...) asm("_ZN2Tz6Select10SetCurrentEibii");
s32 FUN_002892f8(...) asm("_ZN2Tz6Select10GetItemMaxEv");
s32 FUN_0028afa8(...) asm("_ZN2Tz6Select12GetSelectMaxEv");
s32 FUN_0028afd0(...) asm("_ZN2Tz6Select12SetSelectTopEi");
extern u32 DAT_0035f01c asm("D_0035f01c");

// Ghidra decompile of 0x0027c2f8, wrapped mechanically (ad/fallback.py)

void FUN_0027c2f8_impl(void) asm("_ZN2Tz9CmAbility16AdjustInitCurPosEv");
void FUN_0027c2f8_impl(void) {
  int iVar1;
  int iVar2;
  int iVar3;
  int iVar4;
  
  iVar4 = FUN_00257070(0x10);
  iVar1 = FUN_00257088(0x10);
  iVar2 = FUN_0028afa8(DAT_0035f01c);
  iVar3 = FUN_002892f8(DAT_0035f01c);
  if ((iVar2 < iVar1 + iVar3) && (iVar1 = 0, iVar3 < iVar2)) {
    iVar1 = iVar2 - iVar3;
  }
  ...
  FUN_002891f0(DAT_0035f01c,iVar4,0,0xffffffffffffffff,0xffffffffffffffff);
  FUN_0028afd0(DAT_0035f01c,iVar1);
  return;
}
