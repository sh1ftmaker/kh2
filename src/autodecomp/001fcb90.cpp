// coverage: addr=0x001fcb90 symbol=func_001fcb90 size=196 class=float source=corpus status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:71.13;lift:near:67.51;ghidra:near:66.38
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/keProg/pppKeDMatFr.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/keProg/pppKeDMatFr.c"
...
void func_002f3f40(sceVu0FVECTOR v0, sceVu0FVECTOR v1, float s);
...
void func_002f3cd8(sceVu0FVECTOR v0, sceVu0FMATRIX m, sceVu0FVECTOR v1);
...
void func_002f3f98(sceVu0FMATRIX m0, sceVu0FMATRIX m1);
...
void func_002f3d08(sceVu0FMATRIX m0, sceVu0FMATRIX m1, sceVu0FMATRIX m2);
...
# 5 "/data/agent-tom/kh2/autodecomp/out/corpus/overlay/kh1/include/ppp.h" 2
...
extern sceVu0FVECTOR D_00354be0;
...
# 2 "/data/agent-tom/kh2/corpus/kh1/src/ppp/keProg/pppKeDMatFr.c" 2
...
void func_001fcb90_impl(pppPObject* pobj, PKeDMatFr* p, pppCtrlTable* ctbl) asm("func_001fcb90");
void func_001fcb90_impl(pppPObject* pobj, PKeDMatFr* p, pppCtrlTable* ctbl) {
    VKeDMatFr* v = (VKeDMatFr*)&pobj->val[ctbl->useVal[1]];

    func_002f3f40(D_01d9e6e8.next->dmat[0], D_01d9e6e8.next->cmat[0], D_00354be0[0]);
    func_002f3f40(D_01d9e6e8.next->dmat[1], D_01d9e6e8.next->cmat[1], D_00354be0[1]);
    func_002f3f40(D_01d9e6e8.next->dmat[2], D_01d9e6e8.next->cmat[2], D_00354be0[2]);
    func_002f3cd8(D_01d9e6e8.next->dmat[3], D_01d9e840, D_01d9e6e8.next->cmat[3]);
    func_002f3f98(v->MatFr, D_01d9e6e8.next->dmat);
    func_002f3d08(D_01d9e6e8.next->dmat, D_01d9e8c0, D_01d9e6e8.next->dmat);
}
