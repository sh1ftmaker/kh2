// coverage: addr=0x001bc730 symbol=func_001bc730 size=68 class=branchy source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:94.17;m2c:near:88.24;e3:near:41.12
...
s32 FUN_001bc720(...) asm("func_001bc720");
s32 FUN_001bc730(...) asm("func_001bc730");

// Ghidra decompile of 0x001bc730, wrapped mechanically (ad/fallback.py)

void FUN_001bc730_impl(int param_1,int param_2) asm("func_001bc730");
void FUN_001bc730_impl(int param_1,int param_2) {
  if (param_2 < *(int *)(param_1 + 8)) {
    *(int *)(param_1 + 0x6c) = param_2;
    *(uint *)(param_1 + 0x70) = (uint)*(ushort *)(param_2 * 0xc + param_1 + 0xe);
    return;
  }
  FUN_001bc720();
  return;
