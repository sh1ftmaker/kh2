// coverage: addr=0x0015b7c0 symbol=_ZN2dk5Radar6createEPv size=52 class=straight source=m2c status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:68.33;lift:near:51.38
...
// m2c raw+unkfix output for 0x0015b7c0, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_0015B7C0 {
    /* 0x00 */ char pad0[0x10];
};                                                  /* size = 0x10 */

s32 func_0015BAB8(void *) asm("func_0015BAB8");
s32 func_0015B7F8() asm("func_0015B7F8");
void func_0015B7C0(void *arg0 = 0, s32 arg1 = 0, ...) asm("_ZN2dk5Radar6createEPv");
void func_0015b7c0_impl(void *arg0, s32 arg1) asm("_ZN2dk5Radar6createEPv");
void func_0015b7c0_impl(void *arg0, s32 arg1) {
    (*(s32*)((s8*)arg0 + 0xB70)) = arg1;
    (*(s32*)((s8*)arg0 + 0xB74)) = 0x10;
    func_0015B7F8();
    func_0015BAB8(arg0);
}
