// coverage: addr=0x001facd0 symbol=func_001facd0 size=36 class=straight source=corpus status=exact fuzzy=100.0
...
void func_001facd0_impl(pppPObject* pobj, pppCtrlTable* ctbl) asm("func_001facd0");
void func_001facd0_impl(pppPObject* pobj, pppCtrlTable* ctbl) {
