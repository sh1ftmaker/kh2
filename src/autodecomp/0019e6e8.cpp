// coverage: addr=0x0019e6e8 symbol=func_0019e6e8 size=108 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:85.13;lift:near:73.55
...
// m2c raw+unkfix output for 0x0019e6e8, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_0019E6E8 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

s32 func_0019E848(s32 = 0, void * = 0, s32 * = 0, s32 = 0) asm("func_0019E848");
s32 func_001A2478(s32 = 0) asm("func_001A2478");
extern s32 D_0036D3F0 asm("D_0036D3F0");
s32 func_0019E6E8(s32 arg0 = 0, void *arg1 = 0, ...) asm("func_0019e6e8");
s32 func_0019e6e8_impl(s32 arg0, void *arg1) asm("func_0019e6e8");
s32 func_0019e6e8_impl(s32 arg0, void *arg1) {
    s32 temp_t7;
    s32 var_v0;

    temp_t7 = (*(s32*)((s8*)arg1 + 0x48C));
    if ((temp_t7 == 0) || (func_001A2478(temp_t7) == 0)) {
        var_v0 = 0;
    } else {
        var_v0 = func_0019E848(arg0, arg1, &D_0036D3F0, 5);
    }
    return var_v0;
}
