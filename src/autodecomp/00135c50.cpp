// coverage: addr=0x00135c50 symbol=func_00135c50 size=44 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:81.82;corpus:near:81.82;m2c:near:80.91
...
s32 FUN_00135ad0(...) asm("func_00135ad0");
s32 FUN_00135c50(...) asm("func_00135c50");
s32 FUN_00135cc8(...) asm("func_00135cc8");

// Ghidra decompile of 0x00135c50, wrapped mechanically (ad/fallback.py)

void FUN_00135c50_impl(undefined8 param_1,undefined8 param_2) asm("func_00135c50");
void FUN_00135c50_impl(undefined8 param_1,undefined8 param_2) {
  FUN_00135cc8(param_1,param_2,0);
  FUN_00135ad0(param_1);
  return;
}
