// coverage: addr=0x001d6148 symbol=func_001d6148 size=108 class=branchy source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:52.56;m2c:near:52.56
...
s32 FUN_001d5f30(...) asm("_ZN2YS10FORM_LEVEL6AddExpEPNS_6PLAYEREi");
s32 FUN_001d6148(...) asm("_ZN2YS10FORM_LEVEL10CheckLimitEPNS_6PLAYEREi");

// Ghidra decompile of 0x001d6148, wrapped mechanically (ad/fallback.py)

void FUN_001d6148_impl(int param_1,int param_2) asm("_ZN2YS10FORM_LEVEL10CheckLimitEPNS_6PLAYEREi");
void FUN_001d6148_impl(int param_1,int param_2) {
  if (*(int *)(param_1 + 0xb50) != 3) {
    return;
  }
  if (param_2 != 700) {
    if (param_2 < 0x2bd) {
    ...
    else if ((param_2 != 0x2bf) && (param_2 != 0x2c2)) {
      return;
    }
  }
  FUN_001d5f30(param_1,1);
  return;
}
