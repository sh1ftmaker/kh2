// coverage: addr=0x00237640 symbol=func_00237640 size=64 class=straight source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;ghidra:exact:100.0;e3:near:85.94;m2c:compile:0.0
...
// 0x00237640 func_00237640
void func_00237640(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4) asm("func_00237640");
void func_00237640(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4) {
    u32 a1_0;
    u32 t7;
    u32 t7_1;
    u32 t5;
    ...
    u32 t7_3;
    a1_0 = (a1 << 2);
    t7 = *(u16*)((a1_0 + *(u32*)&(((YI_SPRITE*)a0)->sprite_table)));
    t7_1 = (t7 + a2);
    t5 = *(u32*)&(((YI_SPRITE*)a0)->group_table);
    t5_2 = (t5 + (t7_1 * 0x14));
    t6 = *(u32*)(t5_2);
    t7_3 = *(u32*)((t5_2 + 4));
    *(u32*)((t5_2 + 8)) = (t6 + a3);
    *(u32*)((t5_2 + 0xc)) = (t7_3 + a4);
}
