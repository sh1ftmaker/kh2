// coverage: addr=0x0017d930 symbol=func_0017d930 size=52 class=loop source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:75.38;lift:near:70.0;e3:near:42.04
...
s32 FUN_0017d930(...) asm("func_0017d930");

// Ghidra decompile of 0x0017d930, wrapped mechanically (ad/fallback.py)

int FUN_0017d930_impl(int param_1) asm("func_0017d930");
int FUN_0017d930_impl(int param_1) {
  int iVar1;
  int iVar2;
