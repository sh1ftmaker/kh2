// coverage: addr=0x0028d2a0 symbol=func_0028d2a0 size=128 class=float source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:near:61.72;ghidra:near:35.19
...
struct Tz_LightCur {  // class Tz::LightCur size=0x1c0
    ...
    s16 m_SeqNum[3];                                   // +0x198
    s8 m_InitParent;                                   // +0x19e
    s8 m_SetParent;                                    // +0x19f
    f32 m_Time;                                        // +0x1a0
    Tz_PosXY m_FromPos;                                // +0x1a4
    Tz_PosXY m_ToPos;                                  // +0x1ac
    Tz_PosXY m_NowPos;                                 // +0x1b4
};
...
extern "C" u32 func_003142e0(u32, u32) asm("func_003142e0");
extern "C" void func_00138840(u32) asm("func_00138840");

// 0x0028d2a0 func_0028d2a0
// minilink-rodata 0x0037443c   (float literals live here in the original)
void func_0028d2a0(u32 a0) asm("func_0028d2a0");
void func_0028d2a0(u32 a0) {
    u32 t7;
    f32 f2;
    f32 f0;
    t7 = *(u32*)&(((Tz_LightCur*)a0)->super_Sprite.super_Obj2D.m_flag);
    if (((s32)((t7 & 0x100)) == 0)) {
        func_00138840(a0);
        if (((s32)(func_003142e0(0, func_00313b80(*(f32*)&(((Tz_LightCur*)a0)->m_Time)))) <= 0)) {
            f2 = *(f32*)&(((Tz_LightCur*)a0)->m_Time);
            if ((f2 < 30.0f)) {
                f0 = *(f32*)(&D_00349e10);
                *(f32*)&(((Tz_LightCur*)a0)->m_Time) = (f2 + f0);
                if ((30.0f < (f2 + f0))) {
                    *(f32*)&(((Tz_LightCur*)a0)->m_Time) = 30.0f;
                }
            }
        }
    }
