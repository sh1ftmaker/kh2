// coverage: addr=0x00281ec8 symbol=func_00281ec8 size=60 class=straight source=lift status=exact fuzzy=100.0
...
// 0x00281ec8 func_00281ec8
u32 func_00281ec8(u32 a0) asm("func_00281ec8");
