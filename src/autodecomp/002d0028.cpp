// coverage: addr=0x002d0028 symbol=func_002d0028 size=72 class=straight source=lift status=exact fuzzy=100.0
...
// 0x002d0028 func_002d0028
u32 func_002d0028(u32 a0) asm("func_002d0028");
u32 func_002d0028(u32 a0) {
