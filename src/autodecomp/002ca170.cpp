// coverage: addr=0x002ca170 symbol=func_002ca170 size=144 class=straight source=permute status=exact fuzzy=100.0
...
// 0x002ca170 func_002ca170
u32 func_002ca170(u32 a0) asm("func_002ca170");
u32 func_002ca170(u32 a0) {
    *(u32*)((a0 + 0xc)) = 0;
    *(u32*)((a0 + 0x18)) = 0;
