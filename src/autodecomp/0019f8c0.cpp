// coverage: addr=0x0019f8c0 symbol=func_0019f8c0 size=52 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:69.62;ghidra:near:51.25
...
// m2c raw+unkfix output for 0x0019f8c0, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_0019F8C0 {
    /* 0x00 */ char pad0[0x10];
};                                                  /* size = 0x10 */

void *func_0019F7D0() asm("func_0019F7D0");
void * func_0019F8C0(...) asm("func_0019f8c0");
void * func_0019f8c0_impl(void) asm("func_0019f8c0");
void * func_0019f8c0_impl(void) {
    u16 temp_t7;
    void *temp_v0;
    void *var_v0;

    temp_v0 = func_0019F7D0();
    if ((temp_v0 == NULL) || (temp_t7 = (*(s32*)((s8*)temp_v0 + 0x2)), var_v0 = temp_v0 + temp_t7, (temp_t7 == 0))) {
        var_v0 = NULL;
    }
    return var_v0;
}
