// coverage: addr=0x001db440 symbol=func_001db440 size=208 class=branchy source=permute status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:98.71;lift:near:47.65;ghidra:near:29.62
// coverage: addr=0x001db440 symbol=func_001db440 size=208 class=branchy source=m2c status=near fuzzy=98.71
// coverage-alternatives: lift:near:47.65;ghidra:near:29.62
...
// m2c raw output for 0x001db440, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_001DB440 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

s32 **func_001050D8(s32 = 0) asm("func_001050D8");
s32 func_001DAEF8(s32 ** = 0, u16 * = 0) asm("func_001DAEF8");
extern s32 D_003529D8 asm("D_003529D8");
extern s32 D_003529F0 asm("D_003529F0");
extern s32 D_00352A08 asm("D_00352A08");
s32 ** func_001DB440(u16 *arg0 = 0, ...) asm("_ZN2YS4ZONE6CreateEPKNS_14UNIT_DATA_ZONEE");
s32 ** func_001db440_impl(u16 *arg0) asm("_ZN2YS4ZONE6CreateEPKNS_14UNIT_DATA_ZONEE");
s32 ** func_001db440_impl(u16 *arg0) {
    s32 **temp_v0;
    s32 **temp_v0_2;
    s32 **temp_v0_3;
    s32 **var_s0;
    ...
    default:
        ...
        break;
    case 0:
        temp_v0 = func_001050D8(0x70);
        var_s0 = temp_v0;
        func_001DAEF8(temp_v0, arg0);
        var_v0 = var_s0;
        var_t7 = &D_00352A08;
block_8:
        *var_s0 = var_t7;
        break;
    case 2:
        temp_v0_2 = func_001050D8(0x70);
        func_001DAEF8(temp_v0_2, arg0);
        var_s0 = temp_v0_2;
        var_v0 = var_s0;
        var_t7 = &D_003529D8;
        goto block_8;
    case 1:
        temp_v0_3 = func_001050D8(0x70);
        var_s0 = temp_v0_3;
        func_001DAEF8(temp_v0_3, arg0);
        var_v0 = var_s0;
        var_t7 = &D_003529F0;
        goto block_8;
    }
