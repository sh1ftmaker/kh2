// coverage: addr=0x0016e500 symbol=func_0016e500 size=60 class=branchy source=twins status=exact fuzzy=100.0
// coverage-alternatives: lift:near:85.27;m2c:near:85.27;ghidra:near:66.0;e3:near:35.95
...
void func_0016e500_impl(BD_VALUE* param_1) asm("_ZN2YS21trap_effect_set_colorEP8BD_VALUE");
void func_0016e500_impl(BD_VALUE* param_1) {
    kn::FVector* dst = (kn::FVector*)(u32)func_001dc670(param_1[0].u);
