// coverage: addr=0x0019c590 symbol=func_0019c590 size=64 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:87.5;ghidra:near:48.69
...
// m2c raw+unkfix output for 0x0019c590, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_0019C590 {
    /* 0x00 */ char pad0[0x10];
};                                                  /* size = 0x10 */

s32 func_001C8AB0() asm("func_001C8AB0");
s32 func_0019C590(void *arg0 = 0, ...) asm("func_0019c590");
s32 func_0019c590_impl(void *arg0) asm("func_0019c590");
s32 func_0019c590_impl(void *arg0) {
    s32 temp_t7;
    s32 var_v0;

    temp_t7 = (*(s32*)((s8*)arg0 + 0x588));
    var_v0 = 0;
    if (!(temp_t7 & 4)) {
        if (!(temp_t7 & 0x40)) {
            var_v0 = func_001C8AB0() == 1;
        }
    }
    return var_v0;
}
