// coverage: addr=0x0016f770 symbol=func_0016f770 size=48 class=branchy source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:exact:100.0;e3:near:41.12;lift:near:23.46
...
s32 FUN_0016f770(...) asm("func_0016f770");

// Ghidra decompile of 0x0016f770, wrapped mechanically (ad/fallback.py)

uint FUN_0016f770_impl(ulong param_1) asm("func_0016f770");
uint FUN_0016f770_impl(ulong param_1) {
  if ((0x318 < param_1) && ((param_1 < 0x31b || (param_1 == 0x3ee)))) {
    return 1;
  }
  return (int)param_1 >> 0x1d & 1;
}
