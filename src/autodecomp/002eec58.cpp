// coverage: addr=0x002eec58 symbol=_Z16u_call4_002eec58jjjj size=116 class=straight source=lift status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:99.31;m2c:near:99.31;e3:near:96.5
...
// 0x002eec58 u_call4_002eec58(unsigned int, unsigned int, unsigned int, unsigned int)
u32 lift_002eec58(u32 a0) asm("_Z16u_call4_002eec58jjjj");
u32 lift_002eec58(u32 a0) {
    u32 v0;
    u32 v0_0;
