// coverage: addr=0x0016fac8 symbol=func_0016fac8 size=52 class=straight source=twins status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:84.62;m2c:compile:0.0
...
u32 func_0016fac8_impl(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4, u32 a5, u32 a6, u32 a7) asm("func_0016fac8");
u32 func_0016fac8_impl(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4, u32 a5, u32 a6, u32 a7) {
    u32 r5 = a0;
    u32 r6 = (u32)__builtin_return_address(0);
    u32 r4 = *(volatile u32*)((u32)&D_0034dc98 + (s32)(0));
