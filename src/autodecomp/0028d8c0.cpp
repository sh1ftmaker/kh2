// coverage: addr=0x0028d8c0 symbol=_ZN2Tz5Pause16CreateFadeObjectEz size=192 class=straight source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;ghidra:near:86.13;e3:near:85.87;m2c:near:29.04
...
// 0x0028d8c0 Tz::Pause::CreateFadeObject(...)
u32 lift_0028d8c0(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4, u32 a5, u32 a6, u32 a7) asm("_ZN2Tz5Pause16CreateFadeObjectEz");
u32 lift_0028d8c0(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4, u32 a5, u32 a6, u32 a7) {
    u32 s0;
    u32 v0;
    s0 = func_0023c4b8(func_0023f1b0(a4), a2);
    v0 = func_001386e0(a0, a1, s0, func_00236ca8(*(u32*)((func_0023f1b0(a4) + 0x28)), a3), a5, a7);
    *(u32*)&(((dk_Sprite*)a0)->m_nextNum) = a6;
    return v0;
}
