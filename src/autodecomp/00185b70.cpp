// coverage: addr=0x00185b70 symbol=func_00185b70 size=112 class=float source=lift status=exact fuzzy=100.0
...
// 0x00185b70 func_00185b70
// minilink-rodata 0x0036c904   (float literals live here in the original)
void func_00185b70(u32 a0) asm("func_00185b70");
void func_00185b70(u32 a0) {
    func_001d7cd0(a0);
