// coverage: addr=0x001eb228 symbol=func_001eb228 size=120 class=float source=corpus status=exact fuzzy=100.0
// coverage-alternatives: lift:near:63.06;ghidra:near:53.87;m2c:near:0.0
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppChrXSclXYZMatrix.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppChrXSclXYZMatrix.c"
...
# 2 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppChrXSclXYZMatrix.c" 2
...
void func_001eb228_impl(pppPObject* pobj, PChrXSclXYZMatrix* p) asm("func_001eb228");
void func_001eb228_impl(pppPObject* pobj, PChrXSclXYZMatrix* p) {
    sceVu0FMATRIX m;
