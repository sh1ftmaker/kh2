// coverage: addr=0x00259570 symbol=func_00259570 size=68 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:91.11;m2c:near:89.72
...
s32 FUN_00259460(...) asm("func_00259460");
s32 FUN_00259570(...) asm("func_00259570");
s32 FUN_002595b8(...) asm("func_002595b8");

// Ghidra decompile of 0x00259570, wrapped mechanically (ad/fallback.py)

void FUN_00259570_impl(undefined8 param_1,undefined8 param_2,undefined1 param_3,undefined1 param_4) asm("func_00259570");
void FUN_00259570_impl(undefined8 param_1,undefined8 param_2,undefined1 param_3,undefined1 param_4) {
  undefined8 uVar1;
  
  uVar1 = FUN_00259460(param_1,param_3);
  FUN_002595b8(uVar1,param_2,param_4);
  return;
}
