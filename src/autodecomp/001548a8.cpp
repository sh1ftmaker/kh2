// coverage: addr=0x001548a8 symbol=func_001548a8 size=100 class=loop source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:93.46;lift:near:92.85
...
s32 FUN_001395a8(...) asm("func_001395a8");
s32 FUN_001548a8(...) asm("func_001548a8");

// Ghidra decompile of 0x001548a8, wrapped mechanically (ad/fallback.py)

void FUN_001548a8_impl(int param_1,int param_2) asm("func_001548a8");
void FUN_001548a8_impl(int param_1,int param_2) {
  bool bVar1;
  int iVar2;
  
  if ((*(int *)(param_1 + 0x3cd0) != 0) && (iVar2 = 0, 0 < param_2)) {
    param_1 = param_1 + 0xb58;
    do {
      bVar1 = iVar2 < 0x10;
      iVar2 = iVar2 + 1;
      if (bVar1) {
        FUN_001395a8(param_1);
      }
      param_1 = param_1 + 0x330;
    } while (iVar2 < param_2);
  }
  return;
}
