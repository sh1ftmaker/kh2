// coverage: addr=0x001eb030 symbol=func_001eb030 size=148 class=float source=corpus status=exact fuzzy=100.0
// coverage-alternatives: lift:near:59.17;ghidra:near:32.22;m2c:near:27.03
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppChrSclXYZMatrix.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppChrSclXYZMatrix.c"
...
# 2 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppChrSclXYZMatrix.c" 2
...
void func_001eb030_impl(pppPObject* pobj, PChrSclXYZMatrix* p) asm("func_001eb030");
void func_001eb030_impl(pppPObject* pobj, PChrSclXYZMatrix* p) {
    sceVu0FMATRIX m;
    ...
    m[1][1] = D_01d9e6e0->scaleY + (D_01d9e6e0->scaleY * p->sclr);
    if (m[1][1] > p->maxscl) {
        m[1][1] = p->maxscl;
    }
