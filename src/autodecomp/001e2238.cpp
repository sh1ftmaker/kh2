// coverage: addr=0x001e2238 symbol=func_001e2238 size=96 class=loop source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:exact:100.0;lift:near:90.21
...
s32 FUN_001e1728(...) asm("func_001e1728");
s32 FUN_001e2238(...) asm("func_001e2238");

// Ghidra decompile of 0x001e2238, wrapped mechanically (ad/fallback.py)

void FUN_001e2238_impl(int param_1) asm("func_001e2238");
void FUN_001e2238_impl(int param_1) {
  int iVar1;
  int iVar2;
  
  iVar2 = 0;
  if (0 < *(int *)(param_1 + 0xdcc)) {
    iVar1 = 0;
    do {
      iVar2 = iVar2 + 1;
      FUN_001e1728(*(int *)(param_1 + 0xdc8) + iVar1);
      iVar1 = iVar1 + 0x30;
    } while (iVar2 < *(int *)(param_1 + 0xdcc));
  }
  return;
}
