// coverage: addr=0x0031ff88 symbol=func_0031ff88 size=52 class=straight source=lift status=exact fuzzy=100.0
...
// 0x0031ff88 func_0031ff88
u32 func_0031ff88(u32 a0) asm("func_0031ff88");
u32 func_0031ff88(u32 a0) {
