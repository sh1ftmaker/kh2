// coverage: addr=0x002dab30 symbol=func_002dab30 size=52 class=straight source=lift status=exact fuzzy=100.0
...
// 0x002dab30 func_002dab30
u32 func_002dab30(u32 a0) asm("func_002dab30");
u32 func_002dab30(u32 a0) {
