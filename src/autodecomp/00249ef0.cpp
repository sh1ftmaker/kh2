// coverage: addr=0x00249ef0 symbol=_ZN2Tz4TRTE8SetupSelEv size=340 class=loop source=twins status=exact fuzzy=100.0
...
extern "C" SeqInfoTableLayout D_00371f58 asm("D_00371f58");
extern "C" void* D_0035ed74 asm("D_0035ed74");
extern "C" void* D_0035ed78 asm("D_0035ed78");
extern "C" void* D_0035ed90 asm("D_0035ed90");
...
namespace Tz { class TRTE { public: u32 SetupSel(); }; }
// the definition MUST produce the symbol: _ZN2Tz4HBTE8SetupSelEv  (source: registry)
// original name (E3 debug build): Tz::HBTE::SetupSel()
...
/* Tz::HBTE::SetupSel() */
u32 Tz::TRTE::SetupSel() {
    int cur = 0;

    for (int i = 0; i < 2; i++) {
        if (D_00371f58.e[i].unk10 != 0) {
            cur = i;
        }
        SetItem_288d80(D_0035ed74, i, 0, 0, D_0035ed78, D_00371f58.e[i].unk12,
                       D_00371f58.e[i].unk00, D_00371f58.e[i].unk08);

        SelectItemLayout* p = GetItemPtr_2891b8(D_0035ed74, i);
        SetExOffset_288e08(D_0035ed74, i, GetParamCr_23aa78(p->seq), 0);
    ...
    SetCurrent_2891f0(D_0035ed74, cur, true, 0, 2);
    return SetMsg_2b4388(D_0035ed90, &D_00371f58.e[cur], 0);
}
}
