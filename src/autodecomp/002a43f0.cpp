// coverage: addr=0x002a43f0 symbol=func_002a43f0 size=60 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:93.75;lift:near:55.67
...
// m2c raw output for 0x002a43f0, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_002A43F0 {
    /* 0x00 */ char pad0[0x10];
};                                                  /* size = 0x10 */

s32 func_00287BC0() asm("func_00287BC0");
s32 func_002A43F0(...) asm("func_002a43f0");
s32 func_002a43f0_impl(void) asm("func_002a43f0");
s32 func_002a43f0_impl(void) {
    s32 temp_v0;
    s32 var_t6;

    temp_v0 = func_00287BC0();
    var_t6 = 0;
    if ((temp_v0 == 7) || (temp_v0 == 0x1A)) {
        var_t6 = 1;
    }
    return var_t6;
}
