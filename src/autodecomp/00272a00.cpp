// coverage: addr=0x00272a00 symbol=func_00272a00 size=108 class=loop source=lift status=exact fuzzy=100.0
...
// 0x00272a00 func_00272a00
void func_00272a00() asm("func_00272a00");
void func_00272a00() {
    u32 s0;
    u32 s1;
    ...
    do {
        ...
        *(u32*)((s0 + 0x198)) = func_00192048(*(u16*)(func_00273180(3, s1)));
        s0 = (s0 + 0x1b4);
        s1 = (s1 + 1);
