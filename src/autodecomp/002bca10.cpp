// coverage: addr=0x002bca10 symbol=func_002bca10 size=56 class=loop source=m2c status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:54.58;lift:near:8.5
...
// m2c raw+unkfix output for 0x002bca10, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_002BCA10 {};                 /* size 0x0 */

s32 func_002BCA10(void *arg0 = 0, s32 arg1 = 0, s32 arg2 = 0, ...) asm("func_002bca10");
s32 func_002bca10_impl(void *arg0, s32 arg1, s32 arg2) asm("func_002bca10");
s32 func_002bca10_impl(void *arg0, s32 arg1, s32 arg2) {
    s32 temp_t6;
    s32 var_v0;
    void *var_a0;
    ...
    temp_t6 = var_a0 + 0x84;
loop_1:
    if (((*(s32*)((s8*)var_a0 + 0x4)) != arg1) || (var_v0 = arg2, ((*(s32*)((s8*)var_a0 + 0x0)) != arg2))) {
        var_a0 += 0xC;
