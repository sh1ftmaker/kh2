// coverage: addr=0x002e3840 symbol=func_002e3840 size=76 class=branchy source=twins status=exact fuzzy=100.0
...
void func_002e3840_impl(u32 a0) asm("_ZN2Ti21trap_get_obj_head_posEP8BD_VALUE");
void func_002e3840_impl(u32 a0) {
    u32 s0 = a0;
    kn::FVector tmp;
    func_0016c2b0((u32)&tmp, *(u32*)((u32)*(u32*)((u32)a0 + (s32)(0)) + (s32)(4)));
