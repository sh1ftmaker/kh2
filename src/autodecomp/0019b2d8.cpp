// coverage: addr=0x0019b2d8 symbol=_ZN2YS10UNIT_GROUP6EnableEi size=44 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:exact:100.0;lift:near:97.27;corpus:near:75.0
...
s32 FUN_0019b260(...) asm("func_0019b260");
s32 FUN_0019b2d8(...) asm("_ZN2YS10UNIT_GROUP6EnableEi");

// Ghidra decompile of 0x0019b2d8, wrapped mechanically (ad/fallback.py)

void FUN_0019b2d8_impl(void) asm("_ZN2YS10UNIT_GROUP6EnableEi");
void FUN_0019b2d8_impl(void) {
  int iVar1;
