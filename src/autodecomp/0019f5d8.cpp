// coverage: addr=0x0019f5d8 symbol=func_0019f5d8 size=56 class=loop source=m2c status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:56.21;lift:near:17.5
...
// m2c raw+unkfix output for 0x0019f5d8, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_0019F5D8 {};                 /* size 0x0 */

void * func_0019F5D8(void *arg0 = 0, s32 arg1 = 0, s32 arg2 = 0, ...) asm("func_0019f5d8");
void * func_0019f5d8_impl(void *arg0, s32 arg1, s32 arg2) asm("func_0019f5d8");
void * func_0019f5d8_impl(void *arg0, s32 arg1, s32 arg2) {
    s32 temp_t6;
    void *var_a0;
    void *var_v0;
    ...
    temp_t6 = var_a0 + 0x60;
loop_1:
    if (((*(s32*)((s8*)var_a0 + 0x0)) != arg1) || (var_v0 = var_a0, ((*(s32*)((s8*)var_a0 + 0x4)) != arg2))) {
        var_a0 += 0xC;
        if ((s32) var_a0 >= temp_t6) {
            var_v0 = NULL;
        } else {
            goto loop_1;
        }
