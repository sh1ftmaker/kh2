// coverage: addr=0x0023c5f0 symbol=func_0023c5f0 size=196 class=loop source=permute status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:99.39;m2c:near:99.39;lift:near:53.43
// coverage: addr=0x0023c5f0 symbol=func_0023c5f0 size=196 class=loop source=ghidra status=near fuzzy=99.39
// coverage-alternatives: m2c:near:99.39;lift:near:53.43
...
s32 FUN_00239b50(...) asm("_ZN2YI8SEQUENCE11GetAllFrameEi");
s32 FUN_0023c5f0(...) asm("_ZN2YI6LAYOUT11GetAllFrameEi");

// Ghidra decompile of 0x0023c5f0, wrapped mechanically (ad/fallback.py)

int FUN_0023c5f0_impl(int param_1,int param_2) asm("_ZN2YI6LAYOUT11GetAllFrameEi");
int FUN_0023c5f0_impl(int param_1,int param_2) {
  int iVar1;
  ushort *puVar2;
  int iVar3;
  int iVar4;
  ...
  iVar5 = 0;
  puVar2 = (ushort *)(*(int *)(param_1 + 0x14) + param_2 * 0x14);
  iVar3 = *(int *)(param_1 + 0x10) + (uint)*puVar2 * 0x18;
  iVar4 = 0;
  if (puVar2[1] != 0) {
    do {
      iVar5 = iVar5 + 1;
      iVar1 = FUN_00239b50(*(int *)(param_1 + 0x2c) + *(int *)(iVar3 + 4) * 0x158,
                           *(undefined4 *)(iVar3 + 8));
      iVar1 = iVar1 + *(int *)(iVar3 + 0xc);
      iVar3 = iVar3 + 0x18;
      if (iVar4 < iVar1) {
        iVar4 = iVar1;
      }
    } while (iVar5 < (int)(uint)puVar2[1]);
  }
  return iVar4;
}
