// coverage: addr=0x0017de70 symbol=func_0017de70 size=76 class=float source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:65.52;m2c:near:29.58
...
s32 FUN_0017de70(...) asm("func_0017de70");
extern u32 DAT_00352130 asm("D_00352130");

// Ghidra decompile of 0x0017de70, wrapped mechanically (ad/fallback.py)

void FUN_0017de70_impl(int *param_1) asm("func_0017de70");
void FUN_0017de70_impl(int *param_1) {
  (**(code **)(*param_1 + 0x78))
            (param_1,(int)((float)*(int *)(param_1[0x123] + 4) * *(float *)(DAT_00352130 + 0x58)),0,
             0);
  return;
}
