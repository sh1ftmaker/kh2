// coverage: addr=0x00168b88 symbol=func_00168b88 size=96 class=loop source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:91.25;m2c:near:72.8;e3:near:55.88
...
s32 FUN_00168b88(...) asm("func_00168b88");

// Ghidra decompile of 0x00168b88, wrapped mechanically (ad/fallback.py)

int FUN_00168b88_impl(int param_1,uint param_2,int param_3,int param_4) asm("func_00168b88");
int FUN_00168b88_impl(int param_1,uint param_2,int param_3,int param_4) {
  int iVar1;
  int iVar2;
  ...
  if (0 < *(int *)(param_1 + 4)) {
    do {
      if ((((param_2 == 0xffffffff) || (*(ushort *)(iVar1 * 0x10 + param_1 + 0x10) == param_2)) &&
          (iVar2 = iVar1 * 0x10 + param_1, *(int *)(iVar2 + 0x14) == param_3)) &&
         (param_4 = param_4 + -1, param_4 == -1)) {
        return iVar2 + 0x10;
      }
      iVar1 = iVar1 + 1;
