// coverage: addr=0x0028eab8 symbol=_ZN2Tz8MultiSeq18setParamXYToOffsetEPN2dk6SpriteE size=68 class=straight source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;e3:exact:100.0;ghidra:exact:100.0;m2c:exact:100.0
...
extern "C" u32 func_0023aa18(u32, u32) asm("func_0023aa18");
extern "C" u32 func_0023aa38(u32) asm("func_0023aa38");

// 0x0028eab8 Tz::MultiSeq::setParamXYToOffset(dk::Sprite*)
u32 lift_0028eab8(u32 a0, u32 a1) asm("_ZN2Tz8MultiSeq18setParamXYToOffsetEPN2dk6SpriteE");
u32 lift_0028eab8(u32 a0, u32 a1) {
    u32 v0;
    *(u32*)&(((Tz_MultiSeq*)a0)->m_Offset.x) = func_0023aa18(a1 + 0x18, a1);
    v0 = func_0023aa38(a1 + 0x18);
    *(u32*)&(((Tz_MultiSeq*)a0)->m_Offset.y) = v0;
    return v0;
}
