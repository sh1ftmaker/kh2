// coverage: addr=0x002375b0 symbol=func_002375b0 size=52 class=straight source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;ghidra:exact:100.0;e3:near:98.46;m2c:compile:0.0
...
// 0x002375b0 func_002375b0
void func_002375b0(u32 a0, u32 a1, u32 a2, u32 a3) asm("func_002375b0");
void func_002375b0(u32 a0, u32 a1, u32 a2, u32 a3) {
    u32 a1_0;
    u32 t6;
    u32 t5;
    a1_0 = (a1 << 2);
    t6 = (*(u16*)((a1_0 + *(u32*)&(((YI_SPRITE*)a0)->sprite_table))) + a2);
    t5 = (*(u32*)&(((YI_SPRITE*)a0)->group_table) + (t6 * 0x14));
    *(u32*)((t5 + 0xc)) = (*(u32*)((t5 + 4)) + a3);
}
