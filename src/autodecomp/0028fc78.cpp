// coverage: addr=0x0028fc78 symbol=func_0028fc78 size=240 class=loop source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;ghidra:near:83.52;m2c:compile:0.0
...
struct Tz_MunnyDraw {  // class Tz::MunnyDraw size=0x14
    dk_Sprite *m_Parent;                               // +0x0
    Tz_MultiSeq *m_Munnies;                            // +0x4
    s16 m_ParentSeq[3];                                // +0x8
    u8 _pad0[2];
    s32 m_DummySeq;                                    // +0x10
};
...
extern "C" u32 func_00258d40(u32, u32) asm("func_00258d40");
extern "C" void func_00239700(u32) asm("_ZN2YI8SEQUENCEC1Ev");
extern "C" void func_0028dfe8(u32) asm("func_0028dfe8");

// 0x0028fc78 func_0028fc78
u32 func_0028fc78(u32 a0, u32 a1, u32 a2, u32 a3) asm("func_0028fc78");
u32 func_0028fc78(u32 a0, u32 a1, u32 a2, u32 a3) {
    u32 v0;
    u32 v0_0;
    u32 t4;
    v0 = ((u32(*)(u32, u32, u32, u32))(*(u32*)(*(u32*)(*(u32*)((*(u32*)(&D_00347f80) + 0x14))))))(*(u32*)((*(u32*)(&D_00347f80) + 0x14)), 0x198, 0, a3);
    *(u32*)(v0) = (u32)&D_00347e60;
    *(u32*)((v0 + 0xc)) = 0;
    func_00239700(v0 + 0x18);
    *(u32*)&(((Tz_MunnyDraw*)a0)->m_Parent) = v0;
    v0_0 = ((u32(*)(u32, u32, u32))(*(u32*)(*(u32*)(*(u32*)((*(u32*)(&D_00347f80) + 0x14))))))(*(u32*)((*(u32*)(&D_00347f80) + 0x14)), 0x3c, 0);
    func_0028dfe8(v0_0);
    *(u32*)&(((Tz_MunnyDraw*)a0)->m_Munnies) = v0_0;
    t4 = 0;
    do {
        *(u16*)((((t4 << 1) + a0) + 8)) = *(u16*)(((t4 << 1) + a3));
        t4 = (t4 + 1);
    } while (((s32)(((s32)(t4) < (s32)(3))) != 0));
    *(u32*)&(((Tz_MunnyDraw*)a0)->m_DummySeq) = a1;
    return func_00258d40(a1, a2);
}
