// coverage: addr=0x00113808 symbol=func_00113808 size=64 class=branchy source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:58.44;m2c:near:58.44
...
s32 FUN_00113808(...) asm("_ZNK2kn17FriendPersonality11getHopParamEi");

// Ghidra decompile of 0x00113808, wrapped mechanically (ad/fallback.py)

int FUN_00113808_impl(int param_1,int param_2) asm("_ZNK2kn17FriendPersonality11getHopParamEi");
int FUN_00113808_impl(int param_1,int param_2) {
  int iVar1;
  int iVar2;
  ...
  iVar2 = 0;
  if (iVar1 != 0) {
    if ((param_2 < 0) || (*(int *)(iVar1 + 0xa8) <= param_2)) {
      return 0;
    }
    iVar2 = iVar1 + *(int *)(iVar1 + 0xac) + param_2 * 0x20;
  }
  return iVar2;
}
