// coverage: addr=0x001fcd70 symbol=func_001fcd70 size=188 class=float source=corpus status=exact fuzzy=100.0
// coverage-alternatives: lift:near:83.55;m2c:near:74.82;ghidra:near:54.83
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/keProg/pppKeDMatPht.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/keProg/pppKeDMatPht.c"
...
extern sceVu0FMATRIX D_01dad890;
extern sceVu0FMATRIX D_01dad8d0;
# 2 "/data/agent-tom/kh2/corpus/kh1/src/ppp/keProg/pppKeDMatPht.c" 2

void pppKeDMatPhtCalc(void);



void func_001fcd70_impl(void) asm("func_001fcd70");
void func_001fcd70_impl(void) {
    func_002f3d08(D_01dad890, D_01d9e840, D_01dad8d0);
