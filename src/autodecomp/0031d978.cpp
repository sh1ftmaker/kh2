// coverage: addr=0x0031d978 symbol=func_0031d978 size=64 class=straight source=lift status=exact fuzzy=100.0
...
// 0x0031d978 func_0031d978
void func_0031d978(u32 a0) asm("func_0031d978");
void func_0031d978(u32 a0) {
