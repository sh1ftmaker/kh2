// coverage: addr=0x00176b58 symbol=_ZN2YS5PARTY9GetByPartEi size=136 class=loop source=m2c status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:63.82;lift:near:34.21
...
// m2c raw output for 0x00176b58, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_00176B58 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

s32 func_001D14A0() asm("func_001D14A0");
s32 func_0016A070(s32 = 0) asm("func_0016A070");
s32 func_00176B20(s32 = 0) asm("func_00176B20");
s32 func_00176B58(s32 arg0 = 0, ...) asm("_ZN2YS5PARTY9GetByPartEi");
s32 func_00176b58_impl(s32 arg0) asm("_ZN2YS5PARTY9GetByPartEi");
s32 func_00176b58_impl(s32 arg0) {
    s32 temp_v0;
    s32 var_s1;
    s32 var_v0;
    ...
    var_s1 = 0;
loop_1:
    temp_v0 = func_00176B20(var_s1);
    var_s1 += 1;
    if ((temp_v0 == 0) || (var_v0 = temp_v0, (func_0016A070(temp_v0) != arg0))) {
        if (var_s1 >= 3) {
            var_v0 = 0;
            if (arg0 == 1) {
                return func_001D14A0();
            }
