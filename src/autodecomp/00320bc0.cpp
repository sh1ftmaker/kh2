// coverage: addr=0x00320bc0 symbol=func_00320bc0 size=72 class=straight source=lift status=exact fuzzy=100.0
...
// 0x00320bc0 func_00320bc0
u32 func_00320bc0(u32 a0) asm("func_00320bc0");
u32 func_00320bc0(u32 a0) {
