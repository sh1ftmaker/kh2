// coverage: addr=0x001fcb18 symbol=func_001fcb18 size=120 class=straight source=corpus status=exact fuzzy=100.0
// coverage-alternatives: lift:near:83.13;ghidra:near:65.44;m2c:near:62.29
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/keProg/pppKeDMat.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/keProg/pppKeDMat.c"
...
# 2 "/data/agent-tom/kh2/corpus/kh1/src/ppp/keProg/pppKeDMat.c" 2
...
void func_001fcb18_impl(pppPObject* pobj, PKeDMat* p, pppCtrlTable* ctbl) asm("func_001fcb18");
void func_001fcb18_impl(pppPObject* pobj, PKeDMat* p, pppCtrlTable* ctbl) {
    VKeDMat* v = (VKeDMat*)&pobj->val[ctbl->useVal[1]];

    func_002f3d08(D_01d9e6e8.next->dmat, D_01d9e840, D_01d9e6e8.next->cmat);
    func_002f3f98(v->Mat, D_01d9e6e8.next->dmat);
