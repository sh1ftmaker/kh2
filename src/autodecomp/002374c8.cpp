// coverage: addr=0x002374c8 symbol=func_002374c8 size=64 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: e3:near:85.94;lift:near:62.5;m2c:compile:0.0
...
s32 FUN_002374c8(...) asm("_ZN2YI6SPRITE9SetGroupYEiii");

// Ghidra decompile of 0x002374c8, wrapped mechanically (ad/fallback.py)

void FUN_002374c8_impl(int param_1,int param_2,int param_3,int param_4) asm("_ZN2YI6SPRITE9SetGroupYEiii");
void FUN_002374c8_impl(int param_1,int param_2,int param_3,int param_4) {
  int iVar1;
  int iVar2;
  
  iVar2 = *(int *)(param_1 + 8) +
          ((uint)*(ushort *)(param_2 * 4 + *(int *)(param_1 + 0xc)) + param_3) * 0x14;
  iVar1 = *(int *)(iVar2 + 4);
  *(int *)(iVar2 + 4) = param_4;
  *(int *)(iVar2 + 0xc) = (param_4 + *(int *)(iVar2 + 0xc)) - iVar1;
  return;
}
