// coverage: addr=0x001ac858 symbol=func_001ac858 size=88 class=straight source=typed status=exact fuzzy=100.0
...
// 0x001ac858 func_001ac858
u32 func_001ac858(u32 a0, u32 a1) asm("func_001ac858");
u32 func_001ac858(u32 a0, u32 a1) {
