// coverage: addr=0x002eb068 symbol=func_002eb068 size=44 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:57.27;ghidra:near:51.36
...
// m2c valid-syntax output for 0x002eb068, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_002EB068 {};                 /* size 0x0 */

s32 func_002EB068(void *arg0 = 0, ...) asm("func_002eb068");
s32 func_002eb068_impl(void *arg0) asm("func_002eb068");
s32 func_002eb068_impl(void *arg0) {
    s32 temp_t7;
    s32 var_v0;

    temp_t7 = M2C_FIELD(M2C_FIELD(arg0, void **, 0xC), s32 *, 4);
    var_v0 = 0;
    if (((temp_t7 ^ 0x3D) == 0) || ((temp_t7 ^ 0x33) == 0)) {
        var_v0 = 1;
    }
    return var_v0;
}
