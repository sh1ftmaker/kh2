// coverage: addr=0x0028d0f8 symbol=func_0028d0f8 size=72 class=straight source=typed status=exact fuzzy=100.0
...
// 0x0028d0f8 func_0028d0f8
u32 func_0028d0f8(u32 a0) asm("func_0028d0f8");
u32 func_0028d0f8(u32 a0) {
    *(u32*)(a0) = (u32)&D_00347e60;
    *(u32*)&(((Tz_LightCur*)a0)->super_Sprite.super_Obj2D.m_flag) = 0;
    func_00239700(a0 + 0x18);
    *(u32*)(a0) = (u32)&D_0035f420;
