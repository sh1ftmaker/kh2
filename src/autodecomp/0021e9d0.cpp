// coverage: addr=0x0021e9d0 symbol=func_0021e9d0 size=128 class=float source=corpus status=exact fuzzy=100.0
// coverage-alternatives: lift:near:41.67;ghidra:near:15.63;m2c:near:8.56
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/stdProg/pppGetRotMatrixX.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/stdProg/pppGetRotMatrixX.c"
...
# 2 "/data/agent-tom/kh2/corpus/kh1/src/ppp/stdProg/pppGetRotMatrixX.c" 2

void pppGetRotMatrixX(sceVu0FMATRIX mp, u32 angle);



void func_0021e9d0_impl(sceVu0FMATRIX mp, u32 angle) asm("func_0021e9d0");
void func_0021e9d0_impl(sceVu0FMATRIX mp, u32 angle) {
