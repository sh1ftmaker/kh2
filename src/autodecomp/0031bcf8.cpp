// coverage: addr=0x0031bcf8 symbol=func_0031bcf8 size=156 class=loop source=lift status=exact fuzzy=100.0
...
extern "C" u32 D_0034a5d0 asm("D_0034a5d0");
extern "C" u32 func_00239700(u32) asm("_ZN2YI8SEQUENCEC1Ev");
extern "C" void func_002361a0(u32) asm("func_002361a0");

// 0x0031bcf8 func_0031bcf8
u32 func_0031bcf8(u32 a0) asm("func_0031bcf8");
u32 func_0031bcf8(u32 a0) {
    u32 s0;
    u32 s1;
    u32 s2;
    u32 s3;
    u32 v0_0;
    *(u32*)(a0) = (u32)&D_0034a5d0;
