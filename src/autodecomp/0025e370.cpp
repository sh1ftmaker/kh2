// coverage: addr=0x0025e370 symbol=func_0025e370 size=220 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:45.48;ghidra:near:36.86
...
// m2c raw output for 0x0025e370, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_0025E370 {
    /* 0x00 */ char pad0[0x10];
};                                                  /* size = 0x10 */
...
extern s32 D_00373110 asm("D_00373110");
void func_0025E370(...) asm("func_0025e370");
void func_0025e370_impl(void) asm("func_0025e370");
void func_0025e370_impl(void) {
    s32 temp_v0;
