// coverage: addr=0x00322db8 symbol=_ZN2Tz6LayoutD0Ev size=76 class=straight source=lift status=exact fuzzy=100.0
...
// 0x00322db8 Tz::Layout::~Layout()
u32 lift_00322db8(u32 a0) asm("_ZN2Tz6LayoutD0Ev");
u32 lift_00322db8(u32 a0) {
