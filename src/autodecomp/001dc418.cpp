// coverage: addr=0x001dc418 symbol=func_001dc418 size=108 class=branchy source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:near:89.21;ghidra:near:81.97
...
extern "C" u32 D_00352ae8 asm("D_00352ae8");
extern "C" u32 D_00352b48 asm("D_00352b48");
extern "C" u32 func_001dc4b8(u32) asm("func_001dc4b8");
extern "C" void func_001e2c00(u32) asm("func_001e2c00");
extern "C" void func_001e6c00(u32) asm("func_001e6c00");
extern "C" void func_00321c50(u32, u32) asm("func_00321c50");

// 0x001dc418 func_001dc418
u32 func_001dc418(u32 a0) asm("func_001dc418");
u32 func_001dc418(u32 a0) {
    *(u32*)(a0) = (u32)&D_00352b48;
    if (((s32)(*(u32*)&(((ryj_EFFECT*)a0)->PartMng)) != 0)) {
        func_001e2c00(*(u32*)&(((ryj_EFFECT*)a0)->PartMng));
        func_001e6c00(*(u32*)&(((ryj_EFFECT*)a0)->PartMng));
    }
    func_00321c50((u32)&D_00352ae0, a0);
    *(u32*)(&D_00352ae8) = (*(u32*)(&D_00352ae8) + -1);
    return func_001dc4b8(a0);
}
