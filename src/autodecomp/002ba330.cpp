// coverage: addr=0x002ba330 symbol=func_002ba330 size=36 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: corpus:near:97.67;m2c:near:75.33;lift:near:53.78
...
s32 FUN_002b73ac(...) asm("func_002b73ac");
s32 FUN_002ba330(...) asm("func_002ba330");

// Ghidra decompile of 0x002ba330, wrapped mechanically (ad/fallback.py)

void FUN_002ba330_impl(undefined8 param_1,undefined8 param_2,undefined8 param_3) asm("func_002ba330");
void FUN_002ba330_impl(undefined8 param_1,undefined8 param_2,undefined8 param_3) {
  FUN_002b73ac(2,param_1,param_3,0xffffffffffffffff,param_2);
  return;
}
