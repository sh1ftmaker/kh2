// coverage: addr=0x00123dd0 symbol=_ZNK2kn10ModelMulti9getHrcNumEv size=48 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:99.58;lift:near:95.0;e3:near:46.17
...
s32 FUN_00123dd0(...) asm("_ZNK2kn10ModelMulti9getHrcNumEv");
s32 FUN_00124748(...) asm("func_00124748");

// Ghidra decompile of 0x00123dd0, wrapped mechanically (ad/fallback.py)

void FUN_00123dd0_impl(undefined8 param_1) asm("_ZNK2kn10ModelMulti9getHrcNumEv");
void FUN_00123dd0_impl(undefined8 param_1) {
  undefined8 uVar1;
  
  uVar1 = FUN_00124748(param_1,0);
  (**(code **)(*(int *)uVar1 + 0x1c))(uVar1);
  return;
}
