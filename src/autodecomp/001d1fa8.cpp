// coverage: addr=0x001d1fa8 symbol=func_001d1fa8 size=120 class=straight source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:exact:100.0;e3:near:83.8;ghidra:near:77.59
...
// 0x001d1fa8 func_001d1fa8
u32 func_001d1fa8(u32 a0) asm("func_001d1fa8");
u32 func_001d1fa8(u32 a0) {
    *(u32*)(a0) = (u32)&D_003525c8;
    *(u32*)&(((YS_COMBOCOUNTER*)a0)->super_MISSION_COUNT.super_MISSION2D.super_IMAGE_DATA.Imd) = 0;
    *(u32*)&(((YS_COMBOCOUNTER*)a0)->super_MISSION_COUNT.super_MISSION2D.super_IMAGE_DATA.Sqd) = 0;
    func_00320400(a0 + 0xc);
    func_001d1678(a0, 0xffffffff);
    *(u32*)(a0) = (u32)&D_003525e8;
    *(u32*)&(((YS_COMBOCOUNTER*)a0)->super_MISSION_COUNT.Information) = 0;
    func_001d19e8(a0, 0xffffffff);
    *(u32*)&(((YS_COMBOCOUNTER*)a0)->super_MISSION_COUNT.Value) = 0;
    *(u32*)&(((YS_COMBOCOUNTER*)a0)->ComboMax) = 0;
