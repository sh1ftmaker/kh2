// coverage: addr=0x002bd188 symbol=func_002bd188 size=52 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:73.57;lift:near:33.38
...
s32 FUN_002b6ab8(...) asm("func_002b6ab8");
s32 FUN_002b6adc(...) asm("func_002b6adc");
s32 FUN_002bd188(...) asm("func_002bd188");

// Ghidra decompile of 0x002bd188, wrapped mechanically (ad/fallback.py)

void FUN_002bd188_impl(undefined8 param_1,undefined8 param_2) asm("func_002bd188");
void FUN_002bd188_impl(undefined8 param_1,undefined8 param_2) {
  FUN_002b6adc(2);
  FUN_002b6adc(0,param_2);
  FUN_002b6ab8();
  return;
}
