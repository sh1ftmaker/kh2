// coverage: addr=0x0028da70 symbol=_ZN2Tz6Select11SetSequenceEz size=84 class=branchy source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:exact:100.0;e3:near:99.76;ghidra:near:77.2
...
extern "C" u32 func_00139d78(u32, u32) asm("func_00139d78");

// 0x0028da70 Tz::Select::SetSequence(...)
u32 lift_0028da70(u32 a0, u32 a1) asm("_ZN2Tz6Select11SetSequenceEz");
u32 lift_0028da70(u32 a0, u32 a1) {
    u32 v0;
    u32 v0_0;
    v0 = func_00139d78(a0, a1);
    if ((v0 != 0)) {
        if ((*(u32*)&(((dk_Sprite*)a0)->m_num) != a1)) {
            v0_0 = func_00138c10(a0, a1);
            *(u32*)&(((dk_Sprite*)a0)->m_nextNum) = 0xffffffff;
            v0 = v0_0;
        }
    }
    return v0;
