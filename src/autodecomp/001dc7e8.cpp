// coverage: addr=0x001dc7e8 symbol=_ZN3ryj6EFFECT7is_loopEv size=48 class=straight source=typed status=exact fuzzy=100.0
...
extern "C" u32 func_001e2c78(u32) asm("func_001e2c78");
extern "C" void func_001dc9e0(u32) asm("func_001dc9e0");

// 0x001dc7e8 ryj::EFFECT::is_loop()
u32 lift_001dc7e8(u32 a0) asm("_ZN3ryj6EFFECT7is_loopEv");
u32 lift_001dc7e8(u32 a0) {
    func_001dc9e0(a0);
    return ((u32)(0) < (u32)(func_001e2c78(*(u32*)&(((ryj_EFFECT*)a0)->PartMng))));
}
