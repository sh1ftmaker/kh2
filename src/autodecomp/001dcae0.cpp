// coverage: addr=0x001dcae0 symbol=func_001dcae0 size=184 class=float source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:near:73.3;ghidra:near:38.62
...
extern "C" u32 func_001dc878(u32) asm("func_001dc878");

// 0x001dcae0 func_001dcae0
void func_001dcae0(u32 a0) asm("func_001dcae0");
void func_001dcae0(u32 a0) {
    f32 f2;
    f32 f0;
    f32 f1;
    u32 v0;
    f32 f0_0;
    u32 t7;
    f2 = *(f32*)&(((ryj_EFFECT*)a0)->FadeAdd);
    if (!((f2 == 0.0f))) {
        f0 = *(f32*)(&D_00349e10);
        f1 = *(f32*)&(((ryj_EFFECT*)a0)->Fade);
        *(f32*)&(((ryj_EFFECT*)a0)->Fade) = (f1 + (f2 * f0));
        if (((f1 + (f2 * f0)) < 0.0f)) {
            *(f32*)&(((ryj_EFFECT*)a0)->Fade) = 0.0f;
            *(f32*)&(((ryj_EFFECT*)a0)->FadeAdd) = 0.0f;
        }
        if ((0.0f < *(f32*)&(((ryj_EFFECT*)a0)->Fade))) {
            v0 = func_001dc670(a0);
            f0_0 = *(f32*)((v0 + 0xc));
            *(f32*)((v0 + 0xc)) = (f0_0 * *(f32*)&(((ryj_EFFECT*)a0)->Fade));
        }
    }
    t7 = *(u32*)&(((ryj_EFFECT*)a0)->Flag);
    if (((s32)((t7 & 0x20000)) != 0)) {
        if ((*(f32*)&(((ryj_EFFECT*)a0)->Fade) <= 0.0f)) {
            func_001dc878(a0);
            return;
        } else {
            return;
