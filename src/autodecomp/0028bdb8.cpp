// coverage: addr=0x0028bdb8 symbol=_ZN2Tz13LeadDataLeaveEj size=92 class=branchy source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:near:97.39;ghidra:near:88.08;e3:near:0.0
...
extern "C" u32 func_0028e4c8(u32, u32) asm("func_0028e4c8");
extern "C" u32 func_0028e560(u32, u32, u32, u32) asm("func_0028e560");

// 0x0028bdb8 Tz::LeadDataLeave(unsigned int)
void lift_0028bdb8(u32 a0) asm("_ZN2Tz13LeadDataLeaveEj");
void lift_0028bdb8(u32 a0) {
    if (((s32)(func_0028be58(a0)) != 0)) {
        if ((func_0028e4c8(*(u32*)&(((Tz_ScrollBar*)a0)->m_Bar), 0) != *(s16*)&(((Tz_ScrollBar*)a0)->m_SeqNum[4]))) {
            func_0028e560(*(u32*)&(((Tz_ScrollBar*)a0)->m_Bar), a0 + 0x10, 4, 0xffffffff);
            return;
        } else {
            return;
        }
