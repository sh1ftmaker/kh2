// coverage: addr=0x002877a0 symbol=func_002877a0 size=224 class=branchy source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;ghidra:near:95.96;m2c:near:36.55
...
struct Tz_Mg2DTron {  // class Tz::Mg2DTron size=0x28
    dk_SpriteImage *m_SpImg;                           // +0x0
    dk_Sprite *m_Seq[2];                               // +0x4
    Tz_LayFile m_LayFile;                              // +0xc
};
...
extern "C" u32 D_00374410 asm("D_00374410");
extern "C" u32 func_001386e0(u32, u32, u32, u32, u32, u32) asm("func_001386e0");
extern "C" u32 func_00138c10(u32, u32) asm("func_00138c10");
extern "C" u32 func_00139d78(u32, u32, u32) asm("func_00139d78");
extern "C" u32 func_0023f9c8(u32, u32) asm("func_0023f9c8");

// 0x002877a0 func_002877a0
u32 func_002877a0(u32 a0, u32 a1, u32 a2) asm("func_002877a0");
u32 func_002877a0(u32 a0, u32 a1, u32 a2) {
    if (((s32)(func_00139d78(*(u32*)((((a1 << 2) + a0) + 4)), a1, a2)) != 0)) {
        return func_00138c10(*(u32*)((((a1 << 2) + a0) + 4)), *(s16*)((((((a1 << 2) + a1) + a2) << 1) + (u32)&D_00374410)));
    } else {
        return func_001386e0(*(u32*)((((a1 << 2) + a0) + 4)), 0x6596, func_0023f9c8(a0 + 0xc, 0), *(u32*)&(((Tz_Mg2DTron*)a0)->m_SpImg) + 0x20, *(s16*)((((((a1 << 2) + a1) + a2) << 1) + (u32)&D_00374410)), 0);
    }
}
