// coverage: addr=0x00314190 symbol=func_00314190 size=84 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: corpus:near:95.0;lift:near:83.6;m2c:near:69.55
...
s32 FUN_00314190(...) asm("func_00314190");
s32 FUN_003141e8(...) asm("func_003141e8");
s32 FUN_003146c8(...) asm("func_003146c8");
s32 FUN_003147a0(...) asm("func_003147a0");

// Ghidra decompile of 0x00314190, wrapped mechanically (ad/fallback.py)

void FUN_00314190_impl(undefined8 param_1,undefined8 param_2) asm("func_00314190");
void FUN_00314190_impl(undefined8 param_1,undefined8 param_2) {
  undefined8 uVar1;
  ...
  uStack_20 = param_1;
  uStack_18 = param_2;
  FUN_003147a0(&uStack_20,auStack_60);
  FUN_003147a0(&uStack_18,auStack_40);
  uVar1 = FUN_003141e8(auStack_60,auStack_40);
  FUN_003146c8(uVar1);
  return;
}
