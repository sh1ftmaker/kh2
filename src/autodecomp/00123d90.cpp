// coverage: addr=0x00123d90 symbol=_ZNK2kn10ModelMulti17partName2matrixNoENS_9PART_NAMEE size=60 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:99.33;lift:near:55.6;e3:near:44.71
...
s32 FUN_00123d90(...) asm("_ZNK2kn10ModelMulti17partName2matrixNoENS_9PART_NAMEE");
s32 FUN_00124748(...) asm("func_00124748");

// Ghidra decompile of 0x00123d90, wrapped mechanically (ad/fallback.py)

void FUN_00123d90_impl(undefined8 param_1,undefined8 param_2) asm("_ZNK2kn10ModelMulti17partName2matrixNoENS_9PART_NAMEE");
void FUN_00123d90_impl(undefined8 param_1,undefined8 param_2) {
  undefined8 uVar1;
  
  uVar1 = FUN_00124748(param_1,0);
  (**(code **)(*(int *)uVar1 + 0x18))(uVar1,param_2);
  return;
}
