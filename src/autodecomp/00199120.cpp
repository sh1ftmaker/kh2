// coverage: addr=0x00199120 symbol=_Z16wtarget_00199120jjjj size=104 class=loop source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:99.96;lift:near:83.41;corpus:near:82.31
...
s32 FUN_00198dc0(...) asm("func_00198dc0");
s32 FUN_00199120(...) asm("_Z16wtarget_00199120jjjj");
extern u32 DAT_01c61b48 asm("D_01c61b48");

// Ghidra decompile of 0x00199120, wrapped mechanically (ad/fallback.py)

void FUN_00199120_impl(int param_1,long param_2) asm("_Z16wtarget_00199120jjjj");
void FUN_00199120_impl(int param_1,long param_2) {
  undefined4 *puVar1;
  int iVar2;
