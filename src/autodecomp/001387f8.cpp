// coverage: addr=0x001387f8 symbol=func_001387f8 size=72 class=straight source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:near:99.72;ghidra:near:79.36
...
extern "C" void func_00239988(u32, u32) asm("func_00239988");

// 0x001387f8 func_001387f8
u32 func_001387f8(u32 a0, u32 a1, u32 a2, u32 a3) asm("func_001387f8");
u32 func_001387f8(u32 a0, u32 a1, u32 a2, u32 a3) {
    u32 v0;
    func_00239988(a0 + 0x18, a1);
    v0 = func_00138c10(a0, a3);
