// coverage: addr=0x002ee5d8 symbol=_ZN4menu14TutorialWidgetC1Ei size=76 class=straight source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:exact:100.0;e3:near:100.0;ghidra:near:68.0
...
struct menu_TutorialWidget {  // class menu::TutorialWidget size=0x125c
    menu_Widget super_Widget;                          // +0x0
    s32 phase_;                                        // +0x24
    s32 messageId_;                                    // +0x28
    YS_WINDOW_TUTORIAL messageWindow_;                 // +0x2c
};
...
extern "C" u32 D_00363828 asm("D_00363828");
extern "C" u32 func_001ad330(u32, u32) asm("func_001ad330");
extern "C" void func_002edf28(u32, u32) asm("func_002edf28");

// 0x002ee5d8 menu::TutorialWidget::TutorialWidget(int)
u32 lift_002ee5d8(u32 a0, u32 a1) asm("_ZN4menu14TutorialWidgetC1Ei");
u32 lift_002ee5d8(u32 a0, u32 a1) {
    func_002edf28(a0, a1);
    *(u32*)(a0) = (u32)&D_00363828;
    *(u32*)&(((menu_TutorialWidget*)a0)->phase_) = 0;
    *(u32*)&(((menu_TutorialWidget*)a0)->messageId_) = a1;
    return func_001ad330(a0 + 0x2c, a1);
}
