// coverage: addr=0x00245a90 symbol=_ZN2Tz4HECO8SetupSelEv size=340 class=loop source=twins status=exact fuzzy=100.0
// coverage-alternatives: lift:near:91.58;ghidra:near:73.94;m2c:near:55.22
...
extern "C" SeqInfoTableLayout D_00371c50 asm("D_00371c50");
extern "C" void* D_0035ed24 asm("D_0035ed24");
extern "C" void* D_0035ed28 asm("D_0035ed28");
extern "C" void* D_0035ed38 asm("D_0035ed38");
...
namespace Tz { class HECO { public: u32 SetupSel(); }; }
// the definition MUST produce the symbol: _ZN2Tz4HBTE8SetupSelEv  (source: registry)
// original name (E3 debug build): Tz::HBTE::SetupSel()
...
/* Tz::HBTE::SetupSel() */
u32 Tz::HECO::SetupSel() {
    int cur = 0;

    for (int i = 0; i < 2; i++) {
        if (D_00371c50.e[i].unk10 != 0) {
            cur = i;
        }
        SetItem_288d80(D_0035ed24, i, 0, 0, D_0035ed28, D_00371c50.e[i].unk12,
                       D_00371c50.e[i].unk00, D_00371c50.e[i].unk08);

        SelectItemLayout* p = GetItemPtr_2891b8(D_0035ed24, i);
        SetExOffset_288e08(D_0035ed24, i, GetParamCr_23aa78(p->seq), 0);
    ...
    SetCurrent_2891f0(D_0035ed24, cur, true, 0, 2);
    return SetMsg_2b4388(D_0035ed38, &D_00371c50.e[cur], 0);
}
}
