// coverage: addr=0x001b8ce0 symbol=func_001b8ce0 size=128 class=loop source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:85.3;lift:near:79.75
...
s32 FUN_001b8838(...) asm("func_001b8838");
s32 FUN_001b8ce0(...) asm("_ZN2YS9WORLDFLAG16ProgressCallbackEi");
extern u32 DAT_01d48d90 asm("D_01d48d90");

// Ghidra decompile of 0x001b8ce0, wrapped mechanically (ad/fallback.py)

void FUN_001b8ce0_impl(int param_1) asm("_ZN2YS9WORLDFLAG16ProgressCallbackEi");
void FUN_001b8ce0_impl(int param_1) {
  undefined1 *puVar1;
  int iVar2;
  
  iVar2 = 0;
  puVar1 = (undefined1 *)(DAT_01d48d90 + 8);
  if (0 < *(int *)(DAT_01d48d90 + 4)) {
    do {
      ...
      iVar2 = iVar2 + 1;
      puVar1 = puVar1 + 0x10;
    } while (iVar2 < *(int *)(DAT_01d48d90 + 4));
  }
  return;
}
