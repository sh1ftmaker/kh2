// coverage: addr=0x0019d748 symbol=func_0019d748 size=72 class=branchy source=twins status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:96.67;ghidra:near:49.83;lift:near:42.28
...
u32 func_0019d748_impl(u32 a0) asm("func_0019d748");
u32 func_0019d748_impl(u32 a0) {
    u32 s0 = a0;
    u32 s1 = 0;
    if (func_00181858(s0) != 0) {
        u32 t7 = *(u32*)(s0 + 32);
        t7 = t7 & 1;
        s1 = (0u < t7);
    }
