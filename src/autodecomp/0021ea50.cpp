// coverage: addr=0x0021ea50 symbol=func_0021ea50 size=128 class=float source=corpus status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:22.64;lift:near:19.09;m2c:near:18.92
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/stdProg/pppGetRotMatrixY.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/stdProg/pppGetRotMatrixY.c"
# 1 "/data/agent-tom/kh2/autodecomp/out/corpus/overlay/kh1/include/ppp/pppUtil.h" 1
...
# 5 "/data/agent-tom/kh2/autodecomp/out/corpus/overlay/kh1/include/ppp/pppUtil.h" 2
...
# 6 "/data/agent-tom/kh2/autodecomp/out/corpus/overlay/kh1/include/ppp/pppUtil.h" 2

extern f32 D_00359a20[0x1000];
...
# 2 "/data/agent-tom/kh2/corpus/kh1/src/ppp/stdProg/pppGetRotMatrixY.c" 2

void pppGetRotMatrixY(sceVu0FMATRIX mp, u32 angle);



void func_0021ea50_impl(sceVu0FMATRIX mp, u32 angle) asm("func_0021ea50");
void func_0021ea50_impl(sceVu0FMATRIX mp, u32 angle) {
    f32 sin = D_00359a20[(angle / 16) % 0x1000];
    f32 cos = D_00359a20[((angle + 0x4000) / 16) % 0x1000];
