// coverage: addr=0x00108698 symbol=func_00108698 size=148 class=straight source=permute status=exact fuzzy=100.0
...
// 0x00108698 func_00108698
u32 func_00108698(u32 a0) asm("func_00108698");
u32 func_00108698(u32 a0) {
    u32 v0;
    *(u32*)(a0) = 0;
    *(u8*)((a0 + 7)) = 0xffffff80;
    *(u8*)((a0 + 6)) = 0xffffff80;
