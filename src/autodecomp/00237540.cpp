// coverage: addr=0x00237540 symbol=func_00237540 size=52 class=straight source=typed status=exact fuzzy=100.0
...
// 0x00237540 func_00237540
void func_00237540(u32 a0, u32 a1, u32 a2, u32 a3) asm("func_00237540");
void func_00237540(u32 a0, u32 a1, u32 a2, u32 a3) {
    u32 a1_0;
    u32 t6;
    u32 t5;
    a1_0 = (a1 << 2);
