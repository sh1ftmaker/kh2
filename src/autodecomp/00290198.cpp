// coverage: addr=0x00290198 symbol=func_00290198 size=256 class=loop source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;ghidra:near:84.4;m2c:compile:0.0
...
struct Tz_TimeDraw {  // class Tz::TimeDraw size=0x14
    dk_Sprite *m_Parent;                               // +0x0
    Tz_MultiSeq *m_Time;                               // +0x4
...
// 0x00290198 func_00290198
u32 func_00290198(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4) asm("func_00290198");
u32 func_00290198(u32 a0, u32 a1, u32 a2, u32 a3, u32 a4) {
    u32 v0;
    u32 v0_0;
    u32 t4;
    v0 = ((u32(*)(u32, u32, u32, u32, u32))(*(u32*)(*(u32*)(*(u32*)((*(u32*)(&D_00347f80) + 0x14))))))(*(u32*)((*(u32*)(&D_00347f80) + 0x14)), 0x198, 0, a3, a4);
    *(u32*)(v0) = (u32)&D_00347e60;
    *(u32*)((v0 + 0xc)) = 0;
    func_00239700(v0 + 0x18);
    *(u32*)&(((Tz_TimeDraw*)a0)->m_Parent) = v0;
    v0_0 = ((u32(*)(u32, u32, u32))(*(u32*)(*(u32*)(*(u32*)((*(u32*)(&D_00347f80) + 0x14))))))(*(u32*)((*(u32*)(&D_00347f80) + 0x14)), 0x3c, 0);
    func_0028dfe8(v0_0);
    *(u32*)&(((Tz_TimeDraw*)a0)->m_Time) = v0_0;
    t4 = 0;
    do {
        *(u16*)((((t4 << 1) + a0) + 8)) = *(u16*)(((t4 << 1) + a4));
        t4 = (t4 + 1);
    } while (((s32)(((s32)(t4) < (s32)(3))) != 0));
    *(u32*)&(((Tz_TimeDraw*)a0)->m_DummySeq) = a1;
    return func_00258d58(a1, a2, a3);
}
