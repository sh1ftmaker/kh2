// coverage: addr=0x001dc648 symbol=_ZN3ryj6EFFECT5angleEv size=40 class=straight source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;twins:exact:100.0;ghidra:exact:100.0;m2c:exact:100.0;corpus:near:83.25
...
extern "C" u32 func_001e6ce8(u32) asm("func_001e6ce8");
extern "C" void func_001dc9e0(u32) asm("func_001dc9e0");

// 0x001dc648 ryj::EFFECT::angle()
u32 lift_001dc648(u32 a0) asm("_ZN3ryj6EFFECT5angleEv");
u32 lift_001dc648(u32 a0) {
    func_001dc9e0(a0);
    return func_001e6ce8(*(u32*)&(((ryj_EFFECT*)a0)->PartMng));
}
