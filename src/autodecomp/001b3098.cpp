// coverage: addr=0x001b3098 symbol=func_001b3098 size=128 class=loop source=m2c status=exact fuzzy=100.0
...
// m2c valid-syntax output for 0x001b3098, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_001B3098 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

M2C_UNK func_00105110(s32 = 0) asm("func_00105110");
M2C_UNK func_00165768(s32 = 0) asm("func_00165768");
void func_001B3098(void *arg0 = 0, ...) asm("func_001b3098");
void func_001b3098_impl(void *arg0) asm("func_001b3098");
void func_001b3098_impl(void *arg0) {
    s32 temp_a0;
    s32 var_s1;
    s32 var_s2;
    void *temp_t7;
