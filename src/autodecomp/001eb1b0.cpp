// coverage: addr=0x001eb1b0 symbol=func_001eb1b0 size=120 class=float source=corpus status=exact fuzzy=100.0
// coverage-alternatives: lift:near:64.88;m2c:near:8.03;ghidra:near:1.6
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppChrYSclXYZMatrix.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppChrYSclXYZMatrix.c"
...
# 2 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppChrYSclXYZMatrix.c" 2
...
void func_001eb1b0_impl(pppPObject* pobj, PChrYSclXYZMatrix* p) asm("func_001eb1b0");
void func_001eb1b0_impl(pppPObject* pobj, PChrYSclXYZMatrix* p) {
    sceVu0FMATRIX m;
