// coverage: addr=0x00324980 symbol=func_00324980 size=72 class=straight source=lift status=exact fuzzy=100.0
...
// 0x00324980 func_00324980
u32 func_00324980(u32 a0) asm("func_00324980");
u32 func_00324980(u32 a0) {
