// coverage: addr=0x00138748 symbol=func_00138748 size=176 class=float source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;ghidra:near:75.66;m2c:near:75.0
...
extern "C" void func_0031ac78(u32, u32) asm("func_0031ac78");

// 0x00138748 func_00138748
// minilink-rodata 0x0036aca4   (float literals live here in the original)
void func_00138748(u32 a0) asm("func_00138748");
void func_00138748(u32 a0) {
    *(u32*)&(((dk_Sprite*)a0)->m_posx) = 0;
    *(u32*)&(((dk_Sprite*)a0)->m_posy) = 0;
    *(u32*)&(((dk_Sprite*)a0)->m_offsetx) = 0;
    *(u32*)&(((dk_Sprite*)a0)->m_offsety) = 0;
    *(f32*)&(((dk_Sprite*)a0)->m_scale) = 1.0f;
    *(u32*)&(((dk_Sprite*)a0)->m_parent) = 0;
    func_001396b0(a0);
    if (((s32)(*(u32*)&(((dk_Sprite*)a0)->m_parent)) != 0)) {
        *(u32*)&(((dk_Sprite*)a0)->m_ParentSeq) = 0;
        func_001396b0(a0);
        if (((s32)(*(u32*)&(((dk_Sprite*)a0)->m_ParentSeq)) != 0)) {
            func_0031a260(a0, 0);
        }
    }
    *(u32*)&(((dk_Sprite*)a0)->m_ParentSeq) = 0;
    ...
    *(u8*)&(((dk_Sprite*)a0)->m_ClrImgCache) = 0;
    return;
}
