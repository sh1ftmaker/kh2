// coverage: addr=0x00142900 symbol=func_00142900 size=64 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:99.69;lift:near:48.75
...
s32 FUN_00141970(...) asm("func_00141970");
s32 FUN_00142900(...) asm("func_00142900");
s32 FUN_001450e8(...) asm("func_001450e8");

// Ghidra decompile of 0x00142900, wrapped mechanically (ad/fallback.py)

void FUN_00142900_impl(int param_1,undefined8 param_2,undefined8 param_3) asm("func_00142900");
void FUN_00142900_impl(int param_1,undefined8 param_2,undefined8 param_3) {
  int iVar1;
  undefined8 uVar2;
  
  iVar1 = *(int *)(param_1 + 4);
  uVar2 = FUN_00141970();
  FUN_001450e8(iVar1 + 0x10,uVar2,param_3);
  return;
}
