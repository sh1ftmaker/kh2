// coverage: addr=0x001a8f68 symbol=func_001a8f68 size=144 class=loop source=m2c status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:97.78;lift:near:10.5
...
// m2c raw output for 0x001a8f68, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_001A8F68 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

s32 func_001A8C60(s32, s32, s32) asm("func_001A8C60");
s32 func_001A8BF8(s32 = 0, s32 = 0) asm("func_001A8BF8");
s32 func_001A8C60(s32 = 0, s32 = 0, s32 = 0) asm("func_001A8C60");
s32 func_001A8F10(s32 = 0) asm("func_001A8F10");
void func_001A8F68(s32 arg0 = 0, s32 arg1 = 0, ...) asm("func_001a8f68");
void func_001a8f68_impl(s32 arg0, s32 arg1) asm("func_001a8f68");
void func_001a8f68_impl(s32 arg0, s32 arg1) {
    s32 temp_s2;
    s32 var_s0;

    var_s0 = 1;
    temp_s2 = func_001A8F10(arg1);
loop_1:
    if (func_001A8BF8(arg0, var_s0) != temp_s2) {
        var_s0 += 1;
        if (var_s0 < 3) {
            goto loop_1;
        }
    } else {
        func_001A8C60(arg0, var_s0, func_001A8BF8(arg0, 3));
    }
    func_001A8C60(arg0, 3, temp_s2);
}
