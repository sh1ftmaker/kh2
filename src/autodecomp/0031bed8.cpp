// coverage: addr=0x0031bed8 symbol=func_0031bed8 size=120 class=loop source=typed status=exact fuzzy=100.0
...
u32 func_0031bed8(u32 a0) {
    u32 s1;
    u32 s2;
    u32 v0_0;
    *(u32*)&(((Tz_TimeDraw*)a0)->m_Parent) = (u32)&D_0034a660;
    *(u32*)((a0 + 0xc)) = 0;
