// coverage: addr=0x00172890 symbol=func_00172890 size=76 class=branchy source=twins status=exact fuzzy=100.0
...
void func_00172890_impl(u32 a0) asm("_ZN2YS26trap_obj_get_path_movementEP8BD_VALUE");
void func_00172890_impl(u32 a0) {
    u32 s0 = a0;
    kn::FVector tmp;
    func_001850a0((u32)&tmp, *(u32*)((u32)*(u32*)((u32)a0 + (s32)(0)) + (s32)(4)));
