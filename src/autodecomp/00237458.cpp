// coverage: addr=0x00237458 symbol=func_00237458 size=64 class=straight source=ghidra status=exact fuzzy=100.0
...
s32 FUN_00237458(...) asm("_ZN2YI6SPRITE9SetGroupXEiii");

// Ghidra decompile of 0x00237458, wrapped mechanically (ad/fallback.py)

void FUN_00237458_impl(int param_1,int param_2,int param_3,int param_4) asm("_ZN2YI6SPRITE9SetGroupXEiii");
void FUN_00237458_impl(int param_1,int param_2,int param_3,int param_4) {
  int iVar1;
  int *piVar2;
  ...
  iVar1 = *piVar2;
  *piVar2 = param_4;
  piVar2[2] = (param_4 + piVar2[2]) - iVar1;
  return;
}
