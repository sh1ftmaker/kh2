// coverage: addr=0x001fb870 symbol=func_001fb870 size=60 class=straight source=corpus status=exact fuzzy=100.0
...
void func_001fb870_impl(pppPObject* pobj, pppCtrlTable* ctbl) asm("func_001fb870");
void func_001fb870_impl(pppPObject* pobj, pppCtrlTable* ctbl) {
