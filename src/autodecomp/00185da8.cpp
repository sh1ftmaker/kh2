// coverage: addr=0x00185da8 symbol=_ZN2YS5ENEMY4EachEPS0_ size=52 class=loop source=m2c status=exact fuzzy=100.0
...
// m2c raw+unkfix output for 0x00185da8, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_00185DA8 {
    /* 0x00 */ char pad0[0x10];
};                                                  /* size = 0x10 */

void *func_001B9BC8(void * = 0) asm("func_001B9BC8");
void func_00185DA8(void *arg0 = 0, ...) asm("_ZN2YS5ENEMY4EachEPS0_");
void func_00185da8_impl(void *arg0) asm("_ZN2YS5ENEMY4EachEPS0_");
void func_00185da8_impl(void *arg0) {
    void *temp_v0;
    void *var_a0;
