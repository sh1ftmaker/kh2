// coverage: addr=0x001fb5b8 symbol=func_001fb5b8 size=224 class=float source=lift status=exact fuzzy=100.0
...
extern "C" f32 func_001fb508(u32, u32, u32) asm("func_001fb508");
extern "C" void func_002f3f88(u32, u32, u32) asm("func_002f3f88");

// 0x001fb5b8 func_001fb5b8
f32 func_001fb5b8(u32 a0, u32 a1, u32 a2) asm("func_001fb5b8");
f32 func_001fb5b8(u32 a0, u32 a1, u32 a2) {
    u32 a0_0;
    u32 s0;
