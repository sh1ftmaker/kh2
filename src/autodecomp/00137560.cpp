// coverage: addr=0x00137560 symbol=_ZN2dk18TREASURE_INFO_BASE6updateEv size=140 class=float source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;m2c:near:76.28;ghidra:near:31.94;e3:near:1.53
...
struct dk_TREASURE_INFO_BASE {  // class dk::TREASURE_INFO_BASE size=0x1c4
    dk_SpriteMessage super_SpriteMessage;              // +0x0
    f32 m_waitTime;                                    // +0x1b4
    s32 m_picId;                                       // +0x1b8
};
...
extern "C" f32 func_00138840(u32) asm("func_00138840");
extern "C" f32 func_00139598(u32) asm("func_00139598");
extern "C" void func_001395a8(u32) asm("func_001395a8");
extern "C" void func_002ba2e8(u32, u32) asm("func_002ba2e8");

// 0x00137560 dk::TREASURE_INFO_BASE::update()
// minilink-rodata 0x0036ac98   (float literals live here in the original)
void lift_00137560(u32 a0) asm("_ZN2dk18TREASURE_INFO_BASE6updateEv");
void lift_00137560(u32 a0) {
    if ((0.0f < *(f32*)&(((dk_TREASURE_INFO_BASE*)a0)->m_waitTime))) {
        *(f32*)&(((dk_TREASURE_INFO_BASE*)a0)->m_waitTime) = (*(f32*)&(((dk_TREASURE_INFO_BASE*)a0)->m_waitTime) - *(f32*)(&D_00349e14));
        func_00139598(a0);
        return;
    } else {
        if ((-20000.0f < *(f32*)&(((dk_TREASURE_INFO_BASE*)a0)->m_waitTime))) {
            func_002ba2e8(0xa, 0);
            *(f32*)&(((dk_TREASURE_INFO_BASE*)a0)->m_waitTime) = -20000.0f;
        }
        func_001395a8(a0);
        func_00138840(a0);
        return;
