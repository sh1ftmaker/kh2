// coverage: addr=0x001d5030 symbol=func_001d5030 size=52 class=straight source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:98.46;m2c:near:33.67
...
s32 FUN_001d5030(...) asm("func_001d5030");
extern u32 DAT_00352768 asm("D_00352768");
extern u32 DAT_01d5ba68 asm("D_01d5ba68");

// Ghidra decompile of 0x001d5030, wrapped mechanically (ad/fallback.py)

void FUN_001d5030_impl(undefined4 param_1) asm("func_001d5030");
void FUN_001d5030_impl(undefined4 param_1) {
  int iVar1;
  
  DAT_00352768 = param_1;
  iVar1 = FUN_00168b38(param_1,2,0);
  DAT_01d5ba68 = *(undefined4 *)(iVar1 + 8);
  return;
}
