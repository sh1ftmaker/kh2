// coverage: addr=0x001b3018 symbol=func_001b3018 size=128 class=loop source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:91.41;ghidra:near:84.26
...
// m2c valid-syntax output for 0x001b3018, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_001B3018 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

M2C_UNK func_00105110(s32 = 0) asm("_ZN4AREA4FreeEPv");
M2C_UNK func_00165768(s32 = 0) asm("_ZN2dk6ObjOcc7destroyEv");
void func_001B3018(void *arg0 = 0, ...) asm("_ZN2YS6OBJOCCD1Ev");
void func_001b3018_impl(void *arg0) asm("_ZN2YS6OBJOCCD1Ev");
void func_001b3018_impl(void *arg0) {
    s32 temp_a0;
    s32 var_s1;
    s32 var_s2;
    void *temp_t7;

    temp_t7 = M2C_FIELD(arg0, void **, 0);
    if (temp_t7 != NULL) {
        var_s2 = 0;
        if (M2C_FIELD(temp_t7, s32 *, 4) > 0) {
            var_s1 = 0;
            do {
                var_s2 += 1;
                temp_a0 = M2C_FIELD((var_s1 + M2C_FIELD(arg0, s32 *, 4)), s32 *, 0x80);
                var_s1 += 0x90;
                func_00165768(temp_a0);
            } while (var_s2 < M2C_FIELD(M2C_FIELD(arg0, void **, 0), s32 *, 4));
        }
        func_00105110(M2C_FIELD(arg0, s32 *, 4));
