// coverage: addr=0x00240b48 symbol=func_00240b48 size=68 class=branchy source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:96.47;m2c:near:94.33;e3:near:66.42
...
s32 FUN_001058e8(...) asm("func_001058e8");
s32 FUN_00240b48(...) asm("func_00240b48");
s32 FUN_002fdd68(...) asm("func_002fdd68");
extern u32 DAT_0035ec90 asm("D_0035ec90");

// Ghidra decompile of 0x00240b48, wrapped mechanically (ad/fallback.py)

void FUN_00240b48_impl(int param_1) asm("func_00240b48");
void FUN_00240b48_impl(int param_1) {
  undefined8 uVar1;
  ...
  uVar1 = FUN_001058e8();
  FUN_002fdd68(uVar1,param_1,0x10fc0);
  return;
}
