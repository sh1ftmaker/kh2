// coverage: addr=0x0031ae58 symbol=func_0031ae58 size=176 class=loop source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:93.82;ghidra:near:71.8
...
// m2c valid-syntax output for 0x0031ae58, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_0031AE58 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

s32 func_00168AA0(s32 = 0, M2C_UNK = 0) asm("func_00168AA0");
void *func_00168B38(s32 = 0, M2C_UNK = 0, s32 = 0) asm("func_00168B38");
void func_0031AE58(void *arg0 = 0, s32 arg1 = 0, ...) asm("func_0031ae58");
void func_0031ae58_impl(void *arg0, s32 arg1) asm("func_0031ae58");
void func_0031ae58_impl(void *arg0, s32 arg1) {
    s32 temp_v0;
    s32 var_s2;
    void *var_s1;
    ...
    var_s2 = 0;
    temp_v0 = func_00168AA0(arg1, 0x19);
    M2C_FIELD(arg0, s32 *, 4) = temp_v0;
    if (temp_v0 > 0) {
        var_s1 = arg0;
        do {
            M2C_FIELD(var_s1, s32 *, 0xC) = (s32) M2C_FIELD(func_00168B38(M2C_FIELD(arg0, s32 *, 0), 0x19, var_s2), s32 *, 8);
            if (func_00168B38(M2C_FIELD(arg0, s32 *, 0), 0x18, 0) != NULL) {
                M2C_FIELD(var_s1, s32 *, 8) = (s32) M2C_FIELD(func_00168B38(M2C_FIELD(arg0, s32 *, 0), 0x18, var_s2), s32 *, 8);
            } else {
                M2C_FIELD(var_s1, s32 *, 8) = 0;
            }
            var_s2 += 1;
            var_s1 += 8;
        } while (var_s2 < M2C_FIELD(arg0, s32 *, 4));
    }
}
