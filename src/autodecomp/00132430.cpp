// coverage: addr=0x00132430 symbol=func_00132430 size=132 class=loop source=permute status=exact fuzzy=100.0
...
// 0x00132430 func_00132430
u32 func_00132430(u32 a0) asm("func_00132430");
u32 func_00132430(u32 a0) {
    u32 s0;
    u32 s2;
    u32 s3;
    u32 s0_0;
