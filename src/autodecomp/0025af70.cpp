// coverage: addr=0x0025af70 symbol=func_0025af70 size=220 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:46.38;ghidra:near:36.86;e3:near:17.63
...
// m2c raw output for 0x0025af70, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_0025AF70 {
    /* 0x00 */ char pad0[0x10];
};                                                  /* size = 0x10 */

s32 func_00287CC0(s32) asm("func_00287CC0");
s32 func_002B5188(s32 *, s32) asm("func_002B5188");
s32 func_00233E60() asm("func_00233E60");
s32 func_00233E70(s32 = 0) asm("func_00233E70");
s32 func_00240BB0(s32 = 0) asm("func_00240BB0");
s32 func_002417A0() asm("func_002417A0");
s32 func_00287BC0() asm("func_00287BC0");
s32 func_00287C00(s32 = 0) asm("func_00287C00");
s32 func_00287C10() asm("func_00287C10");
s32 func_00287C30() asm("func_00287C30");
s32 func_00287CC0(s32 = 0) asm("func_00287CC0");
s32 func_00287CD0() asm("func_00287CD0");
s32 func_00287D20(s32 = 0) asm("func_00287D20");
s32 func_002B4EE0() asm("func_002B4EE0");
s32 func_002B4FB8() asm("func_002B4FB8");
extern s32 D_00372EA0 asm("D_00372EA0");
void func_0025AF70(...) asm("func_0025af70");
void func_0025af70_impl(void) asm("func_0025af70");
void func_0025af70_impl(void) {
    s32 temp_v0;

    temp_v0 = func_00287CD0();
    if (temp_v0 == 2) {
        if ((func_002B4FB8() == 0) && ((func_00287C10() != 1) || (func_00233E70(0), (func_00233E60() != 0)))) {
            func_00287C30();
            func_00287D20(0);
            if (func_00287BC0() == 0xC) {
                func_002B5188(&D_00372EA0, 0);
            }
        }
    } else {
        if (temp_v0 == 0) {
