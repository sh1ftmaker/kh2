// coverage: addr=0x00168ad8 symbol=func_00168ad8 size=96 class=loop source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: lift:near:91.92;e3:near:63.33;m2c:near:22.88
...
s32 FUN_00168ad8(...) asm("func_00168ad8");

// Ghidra decompile of 0x00168ad8, wrapped mechanically (ad/fallback.py)

void FUN_00168ad8_impl(int param_1,int *param_2,uint param_3,int param_4) asm("func_00168ad8");
void FUN_00168ad8_impl(int param_1,int *param_2,uint param_3,int param_4) {
  int iVar1;
  int iVar2;
  ...
  *param_2 = 0;
  ...
  if (0 < iVar1) {
    do {
      if (((param_3 == 0xffffffff) || (*(ushort *)(iVar2 * 0x10 + param_1 + 0x10) == param_3)) &&
         (*(int *)(iVar2 * 0x10 + param_1 + 0x14) == param_4)) {
        *param_2 = *param_2 + 1;
        iVar1 = *(int *)(param_1 + 4);
      }
      iVar2 = iVar2 + 1;
