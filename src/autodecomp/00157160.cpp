// coverage: addr=0x00157160 symbol=func_00157160 size=92 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:98.7;ghidra:near:73.93
...
// m2c raw+unkfix output for 0x00157160, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_00157160 {
    /* 0x00 */ char pad0[0x10];
};                                                  /* size = 0x10 */

s32 func_001024A8(void *) asm("func_001024A8");
s32 func_001574A0(s32 = 0) asm("func_001574A0");
void *func_0017DF58(s32 = 0) asm("func_0017DF58");
void func_00157160(void *arg0 = 0, ...) asm("func_00157160");
void func_00157160_impl(void *arg0) asm("func_00157160");
void func_00157160_impl(void *arg0) {
    void *temp_v0;

    temp_v0 = func_0017DF58(0);
    if ((temp_v0 != NULL) && ((*(s32*)((s8*)temp_v0 + 0x588)) & 0x400000)) {
        func_001574A0((*(s32*)((s8*)arg0 + 0x4)));
        func_001024A8(arg0);
    }
}
