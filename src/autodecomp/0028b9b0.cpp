// coverage: addr=0x0028b9b0 symbol=func_0028b9b0 size=112 class=straight source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;ghidra:near:82.37;e3:near:55.59;m2c:compile:0.0
...
// 0x0028b9b0 func_0028b9b0
u32 func_0028b9b0(u32 a0) asm("func_0028b9b0");
u32 func_0028b9b0(u32 a0) {
    u32 v0;
    u32 v0_0;
    v0 = ((u32(*)(u32, u32, u32))(*(u32*)(*(u32*)(*(u32*)((*(u32*)(&D_00347f80) + 0x14))))))(*(u32*)((*(u32*)(&D_00347f80) + 0x14)), 0x3c, 0);
    v0_0 = func_0028dfe8(v0);
    *(u32*)&(((Tz_ScrollBar*)a0)->m_Bar) = v0;
    *(u32*)&(((Tz_ScrollBar*)a0)->m_Parent) = 0;
    *(u32*)&(((Tz_ScrollBar*)a0)->m_MaxCnt) = 0;
    *(u32*)&(((Tz_ScrollBar*)a0)->m_DispCnt) = 0;
    *(u32*)&(((Tz_ScrollBar*)a0)->m_SliderPos) = 0;
    *(u32*)&(((Tz_ScrollBar*)a0)->m_BarSize) = 0;
    *(u32*)&(((Tz_ScrollBar*)a0)->m_SliderSize) = 0;
    return v0_0;
}
