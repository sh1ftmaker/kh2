// coverage: addr=0x0013e4b8 symbol=_ZN2dk6LockOn3endEv size=104 class=branchy source=typed status=exact fuzzy=100.0
// coverage-alternatives: lift:exact:100.0;e3:near:99.62;m2c:near:95.74;ghidra:near:70.81
...
// 0x0013e4b8 dk::LockOn::end()
void lift_0013e4b8(u32 a0) asm("_ZN2dk6LockOn3endEv");
void lift_0013e4b8(u32 a0) {
    if (((s32)(func_00139d78(a0)) != 0)) {
        func_00138c10(a0, *(u32*)&(((dk_LockOn*)a0)->super_Sprite3D.super_Sprite.m_num) + -1);
