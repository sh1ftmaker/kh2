// coverage: addr=0x00258a30 symbol=func_00258a30 size=88 class=branchy source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:91.5;lift:near:86.74
...
s32 FUN_00139d78(...) asm("func_00139d78");
s32 FUN_00258a30(...) asm("func_00258a30");
extern u32 DAT_0035f078 asm("D_0035f078");
extern u32 DAT_0035f07c asm("D_0035f07c");

// Ghidra decompile of 0x00258a30, wrapped mechanically (ad/fallback.py)

bool FUN_00258a30_impl(void) asm("func_00258a30");
bool FUN_00258a30_impl(void) {
  bool bVar1;
  long lVar2;
  
  bVar1 = false;
  if (DAT_0035f07c != 0) {
    lVar2 = FUN_00139d78(DAT_0035f07c);
    bVar1 = lVar2 != 0;
  }
  if ((bVar1 == false) && (DAT_0035f078 != 0)) {
    lVar2 = FUN_00139d78(DAT_0035f078);
    bVar1 = lVar2 != 0;
  }
  return bVar1;
}
