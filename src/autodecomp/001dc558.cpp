// coverage: addr=0x001dc558 symbol=_ZN3ryj6EFFECT5startEf size=152 class=float source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:90.64;ghidra:near:80.0
...
// m2c raw+unkfix output for 0x001dc558, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_001DC558 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

s32 func_001E2C00(s32 = 0) asm("func_001E2C00");
s32 func_001E6B90() asm("func_001E6B90");
s32 func_001E6C00(s32 = 0) asm("func_001E6C00");
s32 func_001E6C40(s32 = 0, s32 = 0, s32 = 0, s32 = 0, f32 = 0) asm("func_001E6C40");
s32 func_001DC558(void *arg0 = 0, f32 fparg0 = 0, ...) asm("_ZN3ryj6EFFECT5startEf");
s32 func_001dc558_impl(void *arg0, f32 fparg0) asm("_ZN3ryj6EFFECT5startEf");
s32 func_001dc558_impl(void *arg0, f32 fparg0) {
    s32 temp_t7;
    s32 temp_v0;
    s32 var_s1;

    var_s1 = 1;
    if ((*(s32*)((s8*)arg0 + 0x4)) != 4) {
        temp_v0 = func_001E6B90();
        (*(s32*)((s8*)arg0 + 0x1C)) = temp_v0;
        var_s1 = func_001E6C40(temp_v0, (*(s32*)((s8*)arg0 + 0x14)), (*(s32*)((s8*)arg0 + 0x18)), (*(s32*)((s8*)arg0 + 0x10)), fparg0) != 0;
    }
    if (var_s1 == 0) {
        temp_t7 = (*(s32*)((s8*)arg0 + 0x1C));
        if (temp_t7 != 0) {
            func_001E2C00(temp_t7);
            func_001E6C00((*(s32*)((s8*)arg0 + 0x1C)));
            (*(s32*)((s8*)arg0 + 0x1C)) = 0;
        }
    }
    return var_s1;
