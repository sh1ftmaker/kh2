// coverage: addr=0x0019ba60 symbol=_ZN2YS3OBJ8is_existEv size=72 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: ghidra:near:94.74;e3:near:89.72;lift:near:53.67
...
// m2c raw output for 0x0019ba60, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_0019BA60 {
    /* 0x00 */ char pad0[0x20];
};                                                  /* size = 0x20 */

s32 func_0019BAA8(s32 = 0) asm("func_0019BAA8");
s32 func_001BA028() asm("func_001BA028");
s32 func_0019BA60(s32 arg0 = 0, ...) asm("_ZN2YS3OBJ8is_existEv");
s32 func_0019ba60_impl(s32 arg0) asm("_ZN2YS3OBJ8is_existEv");
s32 func_0019ba60_impl(s32 arg0) {
    s32 var_s1;

    var_s1 = 0;
    if (func_001BA028() != 0) {
        var_s1 = func_0019BAA8(arg0) == 0;
    }
    return var_s1;
}
