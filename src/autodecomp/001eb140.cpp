// coverage: addr=0x001eb140 symbol=func_001eb140 size=112 class=float source=corpus status=exact fuzzy=100.0
// coverage-alternatives: lift:near:58.69;m2c:near:22.86;ghidra:near:0.0
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppChrSclYMatrix.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppChrSclYMatrix.c"
...
# 2 "/data/agent-tom/kh2/corpus/kh1/src/ppp/eiProg/pppChrSclYMatrix.c" 2
...
void func_001eb140_impl(pppPObject* pobj, PChrSclYMatrix* p) asm("func_001eb140");
void func_001eb140_impl(pppPObject* pobj, PChrSclYMatrix* p) {
    sceVu0FMATRIX m;
