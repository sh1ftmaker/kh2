// coverage: addr=0x001ea458 symbol=func_001ea458 size=128 class=branchy source=ghidra status=exact fuzzy=100.0
// coverage-alternatives: m2c:near:90.72;lift:near:88.94
...
s32 FUN_001e7a98(...) asm("func_001e7a98");
s32 FUN_001ea458(...) asm("func_001ea458");
extern u32 DAT_01d9e6e0 asm("D_01d9e6e0");

// Ghidra decompile of 0x001ea458, wrapped mechanically (ad/fallback.py)

void FUN_001ea458_impl(undefined4 param_1,int param_2,undefined2 param_3) asm("func_001ea458");
void FUN_001ea458_impl(undefined4 param_1,int param_2,undefined2 param_3) {
  int iVar1;
  int iVar2;
  
  if (*(int *)(param_2 + 0xc) != -1) {
    iVar1 = 0;
    iVar2 = *(int *)(DAT_01d9e6e0 + 0x80) + *(int *)(param_2 + 0xc) * 0x10;
    if (iVar2 != 0) {
      iVar1 = FUN_001e7a98(DAT_01d9e6e0,iVar2);
      *(undefined4 *)(iVar1 + 4) = param_1;
    }
    *(undefined2 *)(iVar1 + *(int *)(param_2 + 0x10) + 0xa0) = param_3;
  }
  return;
}
