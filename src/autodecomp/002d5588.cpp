// coverage: addr=0x002d5588 symbol=func_002d5588 size=44 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:57.27;ghidra:near:0.0
...
// m2c valid-syntax output for 0x002d5588, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_002D5588 {};                 /* size 0x0 */

s32 func_002D5588(void *arg0 = 0, ...) asm("func_002d5588");
s32 func_002d5588_impl(void *arg0) asm("func_002d5588");
s32 func_002d5588_impl(void *arg0) {
    s32 temp_t7;
    s32 var_v0;

    temp_t7 = M2C_FIELD(M2C_FIELD(arg0, void **, 0xC), s32 *, 4);
    var_v0 = 0;
    if (((temp_t7 ^ 0x38) == 0) || ((temp_t7 ^ 0x37) == 0)) {
        var_v0 = 1;
    }
    return var_v0;
}
