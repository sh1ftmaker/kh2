// coverage: addr=0x001b84b8 symbol=_Z13func_001b84b8jjjj size=100 class=branchy source=m2c status=exact fuzzy=100.0
// coverage-alternatives: lift:near:88.08;ghidra:near:55.07
...
// m2c raw+unkfix output for 0x001b84b8, wrapped mechanically (ad/fallback.py)
struct _m2c_stack_func_001B84B8 {
    /* 0x00 */ char pad0[0x10];
};                                                  /* size = 0x10 */

s32 func_001B8420(s32 = 0) asm("func_001B8420");
s32 func_001DB610(s32 = 0, s32 * = 0, void * = 0) asm("func_001DB610");
extern s32 D_001B8520 asm("D_001B8520");
s32 func_001B84B8(void *arg0 = 0, s32 arg1 = 0, ...) asm("_Z13func_001b84b8jjjj");
s32 func_001b84b8_impl(void *arg0, s32 arg1) asm("_Z13func_001b84b8jjjj");
s32 func_001b84b8_impl(void *arg0, s32 arg1) {
    s32 temp_v0;
    s32 var_v0;

    var_v0 = 0;
    if ((*(s32*)((s8*)arg0 + 0x4)) != 0) {
        (*(s32*)((s8*)arg0 + 0x10)) = arg1;
        if ((*(s32*)((s8*)arg0 + 0x8)) == 0) {
            (*(s32*)((s8*)arg0 + 0x8)) = func_001B8420((*(s32*)((s8*)arg0 + 0x0)));
        }
        temp_v0 = func_001DB610((*(s32*)((s8*)arg0 + 0x8)), &D_001B8520, arg0);
        (*(s32*)((s8*)arg0 + 0x8)) = temp_v0;
        var_v0 = temp_v0 != 0;
    }
    return var_v0;
}
