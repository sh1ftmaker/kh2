...
extern "C" SeqInfoTableLayout D_003720a0 asm("D_003720a0");
extern "C" void* D_0035edac asm("D_0035edac");
extern "C" void* D_0035edb0 asm("D_0035edb0");
extern "C" void* D_0035edc0 asm("D_0035edc0");
...
u32 HBTE::SetupSel() {
    ...
    for (int i = 0; i < 2; i++) {
        if (D_003720a0.e[i].unk10 != 0) {
            cur = i;
        }
        SetItem_288d80(D_0035edac, i, 0, 0, D_0035edb0, D_003720a0.e[i].unk12,
                       D_003720a0.e[i].unk00, D_003720a0.e[i].unk08);

        SelectItemLayout* p = GetItemPtr_2891b8(D_0035edac, i);
        SetExOffset_288e08(D_0035edac, i, GetParamCr_23aa78(p->seq), 0);
    ...
    SetCurrent_2891f0(D_0035edac, cur, true, 0, 2);
    return SetMsg_2b4388(D_0035edc0, &D_003720a0.e[cur], 0);
}
}  // namespace Tz
